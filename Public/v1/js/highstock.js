...
*/
(function(M, ja) {
        typeof module === "object" && module.exports ? module.exports = M.document ? ja(M) : ja : M.Highcharts = ja(M)
    }
            ...
            if (d) {
                ...
                if (f.length)
                    f = f.join(":"),
                        ...
                        e !== null && (e = B.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = pa(f, e)
            }
            j.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    function Qb() {
        ...
        hb = b && a.getTimezoneOffset;
        rb = function(a, c, d, h, i, j) {
            var k;
            b ? (k = ea.UTC.apply(0, arguments),
                k += gb(k)) : k = (new ea(a,c,q(d, 1),q(h, 0),q(i, 0),q(j, 0))).getTime();
            return k
        }
        ;
        Eb = c + "Minutes";
    ...
    Ab.prototype = {
        ...
        step: function(a) {
            ...
            if (c.attr && !c.element)
                ...
                this.pos = d.easing((b - this.startTime) / f),
        ...
        initPath: function(a, b, c) {
            ...
            function f(a, b) {
                for (var c = (l - a.length) / k; c > 0 && c--; )
                    m = a.slice().splice(a.length / r - k, k * r),
                        m[0] = b[l - k - c * k],
                    j && (m[k - 6] = m[k - 2],
                        m[k - 5] = m[k - 1]),
                        [].splice.apply(a, [a.length / r, 0].concat(m)),
                    p && c--
            }
            var b = b || "", g, h = a.startX, i = a.endX, j = b.indexOf("C") > -1, k = j ? 7 : 3, l, m, n, b = b.split(" "), c = c.slice(), p = a.isArea, r = p ? 2 : 1, s;
            j && (d(b),
                d(c));
            if (h && i) {
            ...
            b.length && B.isNumber(g) && (l = c.length + g * r * k,
                s ? (e(b, c),
                    f(c, b)) : (e(c, b),
                    f(b, c)));
            return [b, c]
    ...
    var v = B.extend = function(a, b) {
        ...
        , ha = B.isObject = function(a, b) {
            return a && typeof a === "object" && (!b || !Ra(a))
        }
    ...
    pa = function(a, b, c) {
        if (!t(b) || isNaN(b))
            return Q.lang.invalidDate || "";
        var a = q(a, "%Y-%m-%d %H:%M:%S"), d = new ea(b - gb(b)), e, f = d[Fb](), g = d[Gb](), h = d[db](), i = d[jb](), j = d[kb](), k = Q.lang, l = k.weekdays, m = k.shortWeekdays, d = v({
    ...
    B.numberFormat = function(a, b, c, d) {
        var a = +a || 0, b = +b, e = Q.lang, f = (a.toString().split(".")[1] || "").length, g, h, i = Math.abs(a);
        b === -1 ? b = Math.min(f, 20) : z(b) || (b = 2);
        g = String(H(i.toFixed(b)));
        ...
        b && (d = Math.abs(i - g + Math.pow(10, -Math.max(b, f) - 1)),
            a += c + d.toFixed(b).slice(2));
        return a
    }
    ;
    ...
    ya = function(a, b) {
        var c;
        if (b === "width")
            return Math.min(a.offsetWidth, a.scrollWidth) - ya(a, "padding-left") - ya(a, "padding-right");
        else if (b === "height")
            return Math.min(a.offsetHeight, a.scrollHeight) - ya(a, "padding-top") - ya(a, "padding-bottom");
        return (c = M.getComputedStyle(a, void 0)) && H(c.getPropertyValue(b))
    }
    ;
    qa = function(a, b) {
    ...
    U = function(a, b, c) {
        function d(b, c) {
            a.removeEventListener ? a.removeEventListener(b, c, !1) : a.attachEvent && (c = a.hcEventsIE[c.toString()],
    ...
    K = function(a, b, c, d) {
        ...
        e = a.hcEvents;
        var f, g, c = c || {};
        if (C.createEvent && (a.dispatchEvent || a.fireEvent))
            e = C.createEvent("Events"),
                e.initEvent(b, !0, !0),
                e.target = a,
                v(e, c),
        ...
        for (h in b)
            g = new Ab(a,c,h),
                ...
                h === "d" ? (g.paths = g.initPath(a, a.d, b.d),
                    g.toD = b.d,
                    d = 0,
                    f = 1) : a.attr ? d = a.attr(h) : (d = parseFloat(ya(a, h)) || 0,
                h !== "opacity" && (e = "px")),
            f || (f = b[h]),
    ...
    if (M.jQuery)
        M.jQuery.fn.highcharts = function() {
            ...
            if (this[0])
                return a[0] ? (new (B[Ea(a[0]) ? a.shift() : "Chart"])(this[0],a[0],a[1]),
                    this) : ca[$(this[0], "data-highcharts-chart")]
        }
        ;
    C && !C.defaultView && (ya = function(a, b) {
            var c;
            c = {
                width: "clientWidth",
                height: "clientHeight"
            ...
            b === "opacity" && (b = "filter");
            if (c)
                return a.style.zoom = 1,
                    Math.max(a[c] - 2 * ya(a, "padding"), 0);
    ...
    xa.prototype = {
        ...
        init: function(a) {
            ...
            if ((this.input = a) && a.stops)
                this.stops = wa(a.stops, function(a) {
                    return new xa(a[1])
                });
            else
        ...
        get: function(a) {
            ...
            this.stops ? (d = D(b),
                ...
                })) : d = c && z(c[0]) ? a === "rgb" || !a && c[3] === 1 ? "rgb(" + c[0] + "," + c[1] + "," + c[2] + ")" : a === "a" ? c[3] : "rgba(" + c.join(",") + ")" : b;
            return d
        },
        brighten: function(a) {
            var b, c = this.rgba;
    ...
    ba.prototype = {
        ...
        init: function(a, b) {
            this.element = b === "span" ? ia(b) : C.createElementNS(Ta, b);
            this.renderer = a
        },
        ...
        colorGradient: function(a, b, c) {
            ...
            if (f) {
                ...
                f === "radialGradient" && n && !t(g.gradientUnits) && (h = g,
                    g = D(g, d.getRadialAttr(n, h), {
                        gradientUnits: "userSpaceOnUse"
                    }));
                for (p in g)
                    p !== "id" && r.push(p, g[p]);
                for (p in k)
                    r.push(k[p]);
                r = r.join(",");
                i[r] ? n = i[r].attr("id") : (g.id = n = "highcharts-" + Lb++,
                    i[r] = j = d.createElement(f).attr(g).add(d.defs),
                    j.radAttr = h,
                    j.stops = [],
                    o(k, function(a) {
                        a[1].indexOf("rgba") === 0 ? (e = xa(a[1]),
                            l = e.get("rgb"),
                            m = e.get("a")) : (l = a[1],
                            m = 1);
        ...
        applyTextShadow: function(a) {
            var b = this.element, c, d = a.indexOf("contrast") !== -1, e = {}, f = this.renderer.forExport, g = f || b.style.textShadow !== x && !La;
            if (d)
            ...
            if (typeof a === "string")
                ...
                for (d in a) {
                    ...
                    h || (h = this[d + "Setter"] || this._defaultSetter,
                        h.call(this, b, d, e),
                    this.shadows && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(d) && this.updateShadows(d, b, h))
                }
                if (this.doTransform)
        ...
        crisp: function(a) {
            ...
            d = A(e) % 2 / 2;
            a.x = Y(a.x || this.x || 0) + d;
            a.y = Y(a.y || this.y || 0) + d;
            a.width = Y((a.width || this.width || 0) - 2 * d);
            a.height = Y((a.height || this.height || 0) - 2 * d);
            a.strokeWidth = e;
            for (b in a)
            ...
            if (b)
                for (f in a)
                    a[f] !== b[f] && (c[f] = a[f],
                        e = !0);
            if (e) {
                e = this.textWidth = a && a.width && d.nodeName.toLowerCase() === "text" && H(a.width) || this.textWidth;
                b && (a = v(b, c));
                this.styles = a;
                e && (ua || !ma && this.renderer.forExport) && delete a.width;
                if (La && !ma)
                    O(this.element, a);
                else {
                    b = function(a, b) {
        ...
        getBBox: function(a, b) {
            ...
            f = q(b, this.rotation);
            g = f * ta;
            e !== x && (p = ["", f || 0, i && i.fontSize, h.style.width].join(","),
                p = e === "" || cc.test(e) ? "num:" + e.toString().length + p : e + p);
            p && !a && (c = m[p]);
            if (!c) {
                if (h.namespaceURI === Ta || d.forExport) {
                    try {
                        l = this.fakeTS && function(a) {
                            ...
                            ,
                            Ya && k.textShadow ? (j = k.textShadow,
                                k.textShadow = "") : l && l("none"),
                            c = h.getBBox ? v({}, h.getBBox()) : {
                                width: h.offsetWidth,
                ...
                if (d.isSVG) {
                    d = c.width;
                    e = c.height;
                    if (La && i && i.fontSize === "11px" && e.toPrecision(3) === "16.9")
                        c.height = e = 14;
                    if (f)
                        c.width = T(e * na(g)) + T(d * fa(g)),
                            c.height = T(e * fa(g)) + T(d * na(g))
                }
                if (p) {
                    for (; n.length > 250; )
                        delete m[n.shift()];
        ...
        destroy: function() {
            ...
            for (c && o(c, function(b) {
                ...
                b = d.parentGroup,
                    ...
                    delete d.div,
                    d = b;
            a.alignTo && Ba(a.renderer.alignedObjects, a);
            for (e in a)
                delete a[e];
            return null
        },
        ...
        titleSetter: function(a) {
            ...
            b || (b = C.createElementNS(Ta, "title"),
                this.element.appendChild(b));
            b.firstChild && b.removeChild(b.firstChild);
            b.appendChild(C.createTextNode(String(q(a), "").replace(/<[^>]*>/g, "")))
        },
    ...
    ba.prototype.yGetter = ba.prototype.xGetter;
    ba.prototype.translateXSetter = ba.prototype.translateYSetter = ba.prototype.rotationSetter = ba.prototype.verticalAlignSetter = ba.prototype.scaleXSetter = ba.prototype.scaleYSetter = function(a, b) {
        this[b] = a;
        this.doTransform = !0
    }
    ;
    ba.prototype["stroke-widthSetter"] = ba.prototype.strokeSetter = function(a, b, c) {
        ...
        if (this.stroke && this["stroke-width"])
            this.strokeWidth = this["stroke-width"],
                ba.prototype.fillSetter.call(this, this.stroke, "stroke", c),
    ...
    za.prototype = {
        ...
        init: function(a, b, c, d, e, f) {
            ...
            g = d.element;
            a.appendChild(g);
            a.innerHTML.indexOf("xmlns") === -1 && $(g, "xmlns", Ta);
            this.isSVG = !0;
            this.box = g;
            this.boxWrapper = d;
            this.alignedObjects = [];
            this.url = (Ya || vb) && C.getElementsByTagName("base").length ? M.location.href.replace(/#.*?$/, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
            this.createElement("desc").add().element.appendChild(C.createTextNode("Created with Highstock 4.2.6"));
        ...
        buildText: function(a) {
            for (var b = a.element, c = this, d = c.forExport, e = q(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, j, k = $(b, "x"), l = a.styles, m = a.textWidth, n = l && l.lineHeight, p = l && l.textShadow, r = l && l.textOverflow === "ellipsis", s = g.length, Z = m && !a.added && this.box, u = function(a) {
                return n ? H(n) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : l && l.fontSize || c.style.fontSize || 12, a).h
            }, w = function(a) {
                return a.replace(/&lt;/g, "<").replace(/&gt;/g, ">")
            }; s--; )
                b.removeChild(g[s]);
            !f && !p && !r && !m && e.indexOf(" ") === -1 ? b.appendChild(C.createTextNode(w(e))) : (h = /<.*style="([^"]+)".*>/,
                i = /<.*href="(http[^"]+)".*>/,
            Z && Z.appendChild(b),
                ...
                o(e, function(e, f) {
                    ...
                    o(g, function(e) {
                        if (e !== "" || g.length === 1) {
                            var p = {}, s = C.createElementNS(Ta, "tspan"), q;
                            h.test(e) && (q = e.match(h)[1].replace(/(;| |^)color([ :])/, "$1fill$2"),
                                $(s, "style", q));
                            i.test(e) && !d && ($(s, "onclick", 'location.href="' + e.match(i)[1] + '"'),
                                O(s, {
                                    cursor: "pointer"
                                }));
                            e = w(e.replace(/<(.|\n)*?>/g, "") || " ");
                                ...
                                if (m) {
                                    for (var p = e.replace(/([^\^])-/g, "$1- ").split(" "), Z = g.length > 1 || f || p.length > 1 && l.whiteSpace !== "nowrap", o, F, t = [], y = u(s), x = 1, A = a.rotation, v = e, B = v.length; (Z || r) && (p.length || t.length); )
                                        a.rotation = 0,
                                            o = a.getBBox(!0),
                                            F = o.width,
                                        !ma && c.forExport && (F = c.measureSpanWidth(s.firstChild.data, a.styles)),
                                            o = F > m,
                                        j === void 0 && (j = o),
                                            r && j ? (B /= 2,
                                                v === "" || !o && B < 0.5 ? p = [] : (v = e.substring(0, v.length + (o ? -1 : 1) * Ga(B)),
                                                    p = [v + (m > 3 ? "\u2026" : "")],
                                                    s.removeChild(s.firstChild))) : !o || p.length === 1 ? (p = t,
                                                t = [],
                                            p.length && (x++,
                                            ...
                                            q && $(s, "style", q),
                                                b.appendChild(s)),
                                            F > m && (m = F)) : (s.removeChild(s.firstChild),
                                                t.unshift(p.pop())),
                                        p.length && s.appendChild(C.createTextNode(p.join(" ").replace(/- /g, "-")));
                                    a.rotation = A
                                }
                                n++
                            }
            ...
            Z && Z.removeChild(b),
            p && a.applyTextShadow && a.applyTextShadow(p))
        },
        ...
        button: function(a, b, c, d, e, f, g, h, i) {
            ...
            s = h.style;
            delete h.style;
            G(j.element, La ? "mouseover" : "mouseenter", function() {
                k !== 3 && j.attr(f).css(p)
            });
        ...
        symbol: function(a, b, c, d, e, f) {
            var g = this, h, i = this.symbols[a], i = i && i(A(b), A(c), d, e, f), j = /^url\((.*?)\)$/, k, l;
            if (i)
                h = this.path(i),
                    v(h, {
                        symbolName: a,
                ...
                l = function(a, b) {
                    ...
                    ,
                    k = a.match(j)[1],
                    a = Yb[k] || f && f.width && f.height && [f.width, f.height],
                    h = this.image(k).attr({
                        x: b,
                        y: c
                    }),
                    ...
                    a ? l(h, a) : (h.attr({
                        ...
                        ia("img", {
                            onload: function() {
                                ...
                                l(h, Yb[k] = [this.width, this.height]);
                                this.parentNode && this.parentNode.removeChild(this);
                                g.imgCount--;
                                if (!g.imgCount && ca[g.chartIndex].onload)
                                    ca[g.chartIndex].onload()
                            },
                            src: k
                        }),
                        this.imgCount++);
        ...
        symbols: {
            circle: function(a, b, c, d) {
                var e = 0.166 * c;
                return [W, a + c / 2, b, "C", a + c + e, b, a + c + e, b + d, a + c / 2, b + d, "C", a - e, b + d, a - e, b, a + c / 2, b, "Z"]
            },
            ...
            arc: function(a, b, c, d, e) {
                var f = e.start
                    ...
                    , g = na(g)
                    , e = e.end - f < Ca ? 0 : 1;
                return [W, a + c * i, b + c * j, "A", c, c, 0, e, 1, a + c * k, b + c * g, h ? W : R, a + d * k, b + d * g, "A", d, d, 0, e, 0, a + d * i, b + d * j, h ? "" : "Z"]
            },
        ...
        fontMetrics: function(a, b) {
            ...
            !a && b && M.getComputedStyle && (b = b.element || b,
                a = (c = M.getComputedStyle(b, "")) && c.fontSize);
            a = /px/.test(a) ? H(a) : /em/.test(a) ? parseFloat(a) * 12 : 12;
            c = a < 24 ? a + 3 : A(a * 1.2);
            d = A(c * 0.8);
            return {
                h: c,
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            var j = this, k = j.g(i), l = j.text("", 0, 0, g).attr({
                zIndex: 1
            }), m, n, p = 0, r = 3, s = 0, q, u, w, F, L = 0, ka = {}, y, B, C, E, z;
            C = function() {
                var a, b;
                a = l.element.style;
                n = (q === void 0 || u === void 0 || k.styles.textAlign) && t(l.textStr) && l.getBBox();
                k.width = (q || n.width || 0) + 2 * r + s;
                k.height = (u || n.height || 0) + 2 * r;
                y = r + j.fontMetrics(a && a.fontSize, l).b;
                if (B) {
                    if (!m)
                        a = L,
                            b = (h ? -y : 0) + L,
                            k.box = m = j.symbols[d] ? j.symbol(d, a, b, k.width, k.height, ka) : j.rect(a, b, k.width, k.height, 0, ka["stroke-width"]),
            ...
            return v(k, {
                ...
                destroy: function() {
                    U(k.element, "mouseenter");
                    U(k.element, "mouseleave");
                    l && (l = l.destroy());
                    m && (m = m.destroy());
                    ba.prototype.destroy.call(k);
                    k = j = C = E = z = null
                }
            })
        }
    ...
    v(ba.prototype, {
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    if (m !== this.cTT) {
                        ...
                        t(i) && this.setSpanRotation(i, h, j);
                        O(b, {
                            width: "",
                            whiteSpace: l || "nowrap"
                        });
        ...
        setSpanRotation: function(a, b, c) {
            var d = {}
                , e = La ? "-ms-transform" : vb ? "-webkit-transform" : Ya ? "MozTransform" : Xb ? "-o-transform" : "";
            d[e] = d.transform = "rotate(" + a + "deg)";
            d[e + (Ya ? "Origin" : "-origin")] = d.transformOrigin = b * 100 + "% " + c + "px";
            O(this.element, d)
        },
    ...
    if (!ma && !ua)
        da = {
            ...
            updateTransform: ba.prototype.htmlUpdateTransform,
            ...
            getSpanCorrection: function(a, b, c, d, e) {
                var f = d ? fa(d * ta) : 1, g = d ? na(d * ta) : 0, h = q(this.elemHeight, this.element.offsetHeight), i;
                this.xCorr = f < 0 && -a;
                this.yCorr = g < 0 && -h;
                i = f * g < 0;
            ...
            clip: function(a) {
                ...
                a ? (c = a.members,
                    ...
                    a = {
                        clip: ub ? "inherit" : "rect(auto)"
                    });
                return b.css(a)
            },
            css: ba.prototype.htmlCss,
            safeRemoveChild: function(a) {
                a.parentNode && Wa(a)
            },
            destroy: function() {
                this.destroyClip && this.destroyClip();
                return ba.prototype.destroy.apply(this)
            },
            on: function(a, b) {
            ...
            da["stroke-opacitySetter"] = da["fill-opacitySetter"],
            B.VMLElement = da = oa(ba, da),
            da.prototype.ySetter = da.prototype.widthSetter = da.prototype.heightSetter = da.prototype.xSetter,
            da = {
                Element: da,
                isIE8: Pa.indexOf("MSIE 8.0") > -1,
                init: function(a, b, c, d) {
                    var e;
                    this.alignedObjects = [];
                    d = this.createElement(Xa).css(v(this.getStyle(d), {
                        position: "relative"
                    }));
                    e = d.element;
                ...
                color: function(a, b, c, d) {
                    ...
                    if (i) {
                        var k, l, m = a.linearGradient || a.radialGradient, n, p, r, s, q, u = "", a = a.stops, w, F = [], L = function() {
                            h = ['<fill colors="' + F.join(",") + '" opacity="', r, '" o:opacity2="', p, '" type="', i, '" ', u, 'focus="100%" method="any" />'];
                        ...
                        if (c === "fill")
                            if (i === "gradient")
                                c = m.x1 || m[0] || 0,
                                    ...
                                    n = m.x2 || m[2] || 0,
                                    m = m.y2 || m[3] || 0,
                                    u = 'angle="' + (90 - aa.atan((m - a) / (n - c)) * 180 / Ca) + '"',
                                    L();
                            else {
                                var j = m.r, ka = j * 2, t = j * 2, y = m.cx, x = m.cy, A = b.radialReference, v, j = function() {
                                    A && (v = d.getBBox(),
                                        y += (A[0] - v.x) / v.width - 0.5,
                                        x += (A[1] - v.y) / v.height - 0.5,
                                        ka *= A[2] / v.width,
                                        t *= A[2] / v.height);
                                    u = 'src="' + Q.global.VMLRadialGradientURL + '" size="' + ka + "," + t + '" origin="0.5,0.5" position="' + y + "," + x + '" color2="' + q + '" ';
                                    L()
                                };
                                d.added ? j() : d.onAdd = j;
                                j = s
            ...
            B.VMLRenderer = nb = function() {
                this.init.apply(this, arguments)
            }
            ,
            nb.prototype = D(za.prototype, da),
            Za = nb;
    ...
    eb.prototype = {
        addLabel: function() {
            ...
            b = a.labelFormatter.call({
                ...
                value: a.isLog ? V(a.lin2log(e)) : e
            });
            t(d) ? d && d.attr({
                text: b
            }) : (this.labelLength = (this.label = d = t(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(D(g.style)).add(a.labelGroup) : null) && d.getBBox().width,
                this.rotation = 0)
        },
        ...
        handleOverflow: function(a) {
            var b = this.axis, c = a.x, d = b.chart.chartWidth, e = b.chart.spacing, f = q(b.labelLeft, E(b.pos, e[3])), e = q(b.labelRight, y(b.pos + b.len, d - e[1])), g = this.label, h = this.rotation, i = {
                left: 0,
                center: 0.5,
                right: 1
            }[b.labelAlign], j = g.getBBox().width, k = b.getSlotWidth(), l = k, m = 1, n, p = {};
            if (h)
                h < 0 && c - i * j < f ? n = A(c / fa(h * ta) - f) : h > 0 && c + i * j > e && (n = A((d - c) / fa(h * ta)));
            else if (d = c + (1 - i) * j,
                c - i * j < f ? l = a.x + l * (1 - i) - f : d > e && (l = e - a.x + l * i,
                    m = -1),
                l = E(k, l),
            l < k && b.labelAlign === "center" && (a.x += m * (k - l - i * (k - E(j, l)))),
            j > l || b.autoRotation && g.styles.width)
                n = l;
            if (n) {
                p.width = n;
        ...
        getLabelPosition: function(a, b, c, d, e, f, g, h) {
            var i = this.axis
                ...
                , n = e.y;
            t(n) || (n = i.side === 0 ? c.rotation ? -8 : -c.getBBox().height : i.side === 2 ? m.y + 8 : fa(c.rotation * ta) * (m.y - c.getBBox(!1, 0).height / 2));
        ...
        render: function(a, b, c) {
            ...
            this.isActive = !0;
            if (p) {
                j = d.getPlotLinePath(j + F, p * t, b, !0);
                if (l === x) {
                    l = {
                        stroke: r,
                        "stroke-width": p
            ...
            if (m)
                d.opposite && (m[0] = -m[0]),
                    h = this.getMarkPath(ka, L, m[0], m[1] * t, g, f),
                    o ? o.animate({
                        d: h,
                        opacity: c
            ...
            if (i && z(ka))
                i.xy = L = this.getLabelPosition(ka, L, i, g, k, F, a, u),
                    this.isFirst && !this.isLast && !q(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !q(e.showLastLabel, 1) ? w = !1 : g && !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && this.handleOverflow(L),
                u && a % u && (w = !1),
                    w && z(L.y) ? (L.opacity = c,
                        i[this.isNew ? "attr" : "animate"](L)) : (Qa(i),
                        i.attr("y", -9999)),
                    this.isNew = !1
        },
        destroy: function() {
    ...
    B.PlotLineOrBand.prototype = {
        render: function() {
            var a = this, b = a.axis, c = b.horiz, d = a.options, e = d.label, f = a.label, g = d.width, h = d.to, i = d.from, j = t(i) && t(h), k = d.value, l = d.dashStyle, m = a.svgElem, n = [], p, r = d.color, s = q(d.zIndex, 0), o = d.events, u = {}, w = b.chart.renderer, n = b.log2lin;
            b.isLog && (i = n(i),
                h = n(h),
                k = n(k));
            if (g) {
                if (n = b.getPlotLinePath(k, g),
                    u = {
                        stroke: r,
                        "stroke-width": g
                    },
            ...
            if (m)
            ...
            else if (n && n.length && (a.svgElem = m = w.path(n).attr(u).add(),
                o))
                for (p in d = function(b) {
                    ...
                    o)
                    d(p);
            e && t(e.text) && n && n.length && b.width > 0 && b.height > 0 && !n.flat ? (e = D({
                align: c && j && "center",
                x: c ? !j && 4 : 10,
                ...
                this.renderLabel(e, n, j, s)) : f && f.hide();
            return a
        },
    ...
    J.prototype = {
        ...
        defaultYAxisOptions: {
            ...
            stackLabels: {
                ...
                style: D(X.line.dataLabels.style, {
                    color: "#000000"
                })
            }
        },
        ...
        init: function(a, b) {
            ...
            this.crosshair = q(d.crosshair, sa(a.options.tooltip.crosshairs)[c ? 0 : 1], !1);
        ...
        defaultLabelFormatter: function() {
            var a = this.axis, b = this.value, c = a.categories, d = this.dateTimeLabelFormat, e = Q.lang.numericSymbols, f = e && e.length, g, h = a.options.labels.format, a = a.isLog ? b : a.tickInterval;
            if (h)
                g = Ma(h, this);
            else if (c)
                g = b;
                ...
                for (; f-- && g === x; )
                    c = Math.pow(1E3, f + 1),
                    a >= c && b * 10 % c === 0 && e[f] !== null && b !== 0 && (g = B.numberFormat(b / c, -1) + e[f]);
            g === x && (g = T(b) >= 1E4 ? B.numberFormat(b, -1) : B.numberFormat(b, -1, x, ""));
            return g
        },
                ...
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        if (d = c.xData,
                            d.length)
                            c = Na(d),
                            !z(c) && !(c instanceof ea) && (d = Ha(d, function(a) {
                                return z(a)
                            }),
                                c = Na(d)),
                                a.dataMin = E(q(a.dataMin, d[0]), c),
                                a.dataMax = y(q(a.dataMax, d[0]), Fa(d))
                    } else {
                        c.getExtremes();
                        f = c.dataMax;
                        c = c.dataMin;
                        if (t(c) && t(f))
                            a.dataMin = E(q(a.dataMin, c), c),
                                a.dataMax = y(q(a.dataMax, f), f);
                        if (t(e))
                            a.threshold = e;
        ...
        translate: function(a, b, c, d, e, f) {
            ...
            f === "between" && (f = 0.5),
                a = h * (a - d) * j + i + h * k + (z(f) ? j * f * g.pointRange : 0));
            return a
        },
        ...
        getPlotLinePath: function(a, b, c, d, e) {
            ...
            z(e) ? this.horiz ? (i = h,
                j = k - this.bottom,
                a = c = n(a, g, g + this.width)) : (a = g,
                c = l - this.right,
                i = j = n(i, h, h + this.height)) : m = !0;
            return m && !d ? null : f.renderer.crispLine([W, a, i, R, c, j], b || 1)
        },
        getLinearTickPositions: function(a, b, c) {
            var d, e = V(Y(b / a) * a), f = V(Ga(c / a) * a), g = [];
            if (b === c && z(b))
                return [b];
            for (b = e; b <= f; ) {
                g.push(b);
        ...
        adjustForMinRange: function() {
            ...
            if (this.isXAxis && this.minRange === x && !this.isLog)
                t(a.min) || t(a.max) ? this.minRange = null : (o(this.series, function(a) {
                    i = a.xData;
        ...
        getClosest: function() {
            var a;
            this.categories ? a = 1 : o(this.series, function(b) {
                var c = b.closestPointRange;
                !b.noSharedTooltip && t(c) && (a = t(a) ? E(a, c) : c)
            });
            return a
        },
        ...
        setTickInterval: function(a) {
            var b = this, c = b.chart, d = b.options, e = b.isLog, f = b.log2lin, g = b.isDatetimeAxis, h = b.isXAxis, i = b.isLinked, j = d.maxPadding, k = d.minPadding, l = d.tickInterval, m = d.tickPixelInterval, n = b.categories, p = b.threshold, r = b.softThreshold, s, Z, u, w;
            !g && !n && !i && this.getTickAmount();
            u = q(b.userMin, d.min);
            w = q(b.userMax, d.max);
            i ? (b.linkedParent = c[b.coll][d.linkedTo],
                c = b.linkedParent.getExtremes(),
                b.min = q(c.min, c.dataMin),
                b.max = q(c.max, c.dataMax),
            d.type !== b.linkedParent.options.type && ja(11, 1)) : (!r && t(p) && (b.dataMin >= p ? (s = p,
                k = 0) : b.dataMax <= p && (Z = p,
                j = 0)),
                b.min = q(u, s, b.dataMin),
                b.max = q(w, Z, b.dataMax));
            if (e)
                !a && E(b.min, q(b.dataMin, b.min)) <= 0 && ja(10, 1),
                    b.min = V(f(b.min), 15),
                    b.max = V(f(b.max), 15);
            if (b.range && t(b.max))
                b.userMin = b.min = u = y(b.min, b.minFromRange()),
                    b.userMax = w = b.max,
                    b.range = null;
            K(b, "foundExtremes");
            b.beforePadding && b.beforePadding();
            b.adjustForMinRange();
            if (!n && !b.axisPointRange && !b.usePercentage && !i && t(b.min) && t(b.max) && (f = b.max - b.min))
                !t(u) && k && (b.min -= f * k),
                !t(w) && j && (b.max += f * j);
            if (z(d.floor))
                b.min = y(b.min, d.floor);
            if (z(d.ceiling))
                b.max = E(b.max, d.ceiling);
            if (r && t(b.dataMin))
                if (p = p || 0,
                !t(u) && b.min < p && b.dataMin >= p)
                    b.min = p;
                else if (!t(w) && b.max > p && b.dataMax <= p)
                    b.max = p;
            b.tickInterval = b.min === b.max || b.min === void 0 || b.max === void 0 ? 1 : i && !l && m === b.linkedParent.options.tickPixelInterval ? l = b.linkedParent.tickInterval : q(l, this.tickAmount ? (b.max - b.min) / y(this.tickAmount - 1, 1) : void 0, n ? 1 : (b.max - b.min) * m / y(b.len, m));
            ...
            if (b.pointRange && !l)
                b.tickInterval = y(b.pointRange, b.tickInterval);
            a = q(d.minTickInterval, b.isDatetimeAxis && b.closestPointRange);
            if (!l && b.tickInterval < a)
                b.tickInterval = a;
            if (!g && !e && !l)
                b.tickInterval = Db(b.tickInterval, null, Cb(b.tickInterval), q(d.allowDecimals, !(b.tickInterval > 0.5 && b.tickInterval < 5 && b.max > 1E3 && b.max < 9999)), !!this.tickAmount);
        ...
        setTickPositions: function() {
            ...
            if (!this.isLinked)
                ...
                this.min === this.max && t(this.min) && !this.tickAmount && (g = !0,
                    this.min -= 0.5,
                    this.max += 0.5),
                    this.single = g,
        ...
        getTickAmount: function() {
            ...
            !b && this.alignToOthers() && (b = Ga(this.len / c) + 1);
            if (b < 4)
                this.finalTickAmt = b,
                    b = 5;
            this.tickAmount = b
        ...
        zoom: function(a, b) {
            var c = this.dataMin
                ...
                , f = E(c, q(e.min, c))
                , e = y(d, q(e.max, d));
            this.allowZoomOutside || (t(c) && a <= f && (a = f),
            t(d) && b >= e && (b = e));
        ...
        tickSize: function(a) {
            var b = this.options
                , c = b[a + "Length"]
                , d = q(b[a + "Width"], a === "tick" && this.isXAxis ? 1 : 0);
            if (d && c)
                return b[a + "Position"] === "inside" && (c = -c),
                    [c, d]
        },
        ...
        renderUnsquish: function() {
            var a = this.chart, b = a.renderer, c = this.tickPositions, d = this.ticks, e = this.options.labels, f = this.horiz, g = this.getSlotWidth(), h = y(1, A(g - 2 * (e.padding || 5))), i = {}, j = this.labelMetrics(), k = e.style.textOverflow, l, m = 0, n, p;
            if (!Ea(e.rotation))
            ...
            if (this.autoRotation)
                ...
                for (n = c.length; !f && n--; )
                    if (p = c[n],
                        ...
                        h.getBBox().height > this.len / c.length - (j.h - j.f))
                            h.specCss = {
        ...
        getOffset: function() {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, j, k, l = 0, m, n = 0, p = d.title, r = d.labels, s = 0, Z = a.opposite, u = b.axisOffset, b = b.clipOffset, w = [-1, 1, 1, -1][h], F, L = a.axisParent, ka = this.tickSize("tick");
            j = a.hasData();
            ...
            if (p && p.text && p.enabled !== !1) {
                ...
                if (k)
                    l = a.axisTitle.getBBox()[g ? "height" : "width"],
                        m = p.offset,
                        n = t(m) ? 0 : q(p.margin, g ? 5 : 10);
                a.axisTitle[k ? "show" : "hide"](!0)
            }
            a.offset = w * q(d.offset, u[h]);
            ...
            n = Math.abs(s) + n;
            s && (n -= c,
                n += w * (g ? q(r.y, a.tickRotCorr.y + w * 8) : r.x));
            a.axisTitleMargin = q(m, n);
            u[h] = y(u[h], a.axisTitleMargin + l + w * a.offset, n, j && e.length && ka ? ka[0] : 0);
            d = d.offset ? 0 : Y(d.lineWidth / 2) * 2;
            b[i] = y(b[i], d)
        },
        getLinePath: function(a) {
            ...
            c && (a *= -1);
            return b.renderer.crispLine([W, e ? this.left : f, e ? d : this.top, R, e ? b.chartWidth - this.right : f, e ? d : b.chartHeight - this.bottom], a)
        },
        ...
        render: function() {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.isLog, f = a.lin2log, g = a.isLinked, h = a.tickPositions, i = a.axisTitle, j = a.ticks, k = a.minorTicks, l = a.alternateBands, m = d.stackLabels, n = d.alternateGridColor, p = a.tickmarkOffset, r = d.lineWidth, s, q = b.hasRendered && z(a.oldMin), u = a.showAxis, w = ib(c.globalAnimation), F, L;
            ...
            if (a.hasData() || g) {
                ...
                if (h.length && (o(h, function(b, c) {
                    if (!g || b >= a.min && b <= a.max)
                        j[b] || (j[b] = new eb(a,b)),
                        q && j[b].isNew && j[b].render(c, !0, 0.1),
                            j[b].render(c)
                }),
                p && (a.min === 0 || a.single)))
                    j[-1] || (j[-1] = new eb(a,-1,null,!0)),
                        j[-1].render(-1);
                n && o(h, function(c, d) {
                    L = h[d + 1] !== x ? h[d + 1] + p : a.max - p;
                    if (d % 2 === 0 && c < a.max && L <= a.max + (b.polar ? -p : p))
                        l[c] || (l[c] = new B.PlotLineOrBand(a)),
                            F = c + p,
                            l[c].options = {
                                from: e ? f(F) : F,
                                to: e ? f(L) : L,
            ...
            if (r)
                s = a.getLinePath(r),
                    ...
                    a.axisLine[u ? "show" : "hide"](!0);
            if (i && u)
                i[i.isNew ? "attr" : "animate"](a.getTitlePosition()),
                    i.isNew = !1;
        ...
        drawCrosshair: function(a, b) {
            ...
            if (!this.crosshair || (t(b) || !q(d.snap, !0)) === !1)
                this.hideCrosshair();
            else if (q(d.snap, !0) ? t(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos,
                c = this.isRadial ? this.getPlotLinePath(this.isXAxis ? b.x : q(b.stackY, b.y)) || null : this.getPlotLinePath(null, null, null, null, c) || null,
            c === null)
                this.hideCrosshair();
            else {
                e = this.categories && !this.isRadial;
                f = q(d.width, e ? this.transA : 1);
                if (this.cross)
                    this.cross.attr({
                        d: c,
                        visibility: "visible",
    ...
    v(J.prototype, {
        getPlotBandPath: function(a, b) {
            ...
            d && c ? (d.flat = d.toString() === c.toString(),
                d.push(c[4], c[5], c[1], c[2])) : d = null;
            return d
        },
    ...
    J.prototype.getTimeTicks = function(a, b, c, d) {
        var e = [], f = {}, g = Q.global.useUTC, h, i = new ea(b - gb(b)), j = a.unitRange, k = a.count;
        if (t(b)) {
            i[Rb](j >= N.second ? 0 : k * Y(i.getMilliseconds() / k));
            if (j >= N.second)
                i[Sb](j >= N.minute ? 0 : k * Y(i.getSeconds() / k));
            if (j >= N.minute)
                i[Tb](j >= N.hour ? 0 : k * Y(i[Eb]() / k));
            if (j >= N.hour)
                i[Ub](j >= N.day ? 0 : k * Y(i[Fb]() / k));
            if (j >= N.day)
                i[sb](j >= N.month ? 1 : k * Y(i[db]() / k));
            j >= N.month && (i[Hb](j >= N.year ? 0 : k * Y(i[jb]() / k)),
                h = i[kb]());
            j >= N.year && (h -= h % k,
                i[Ib](h));
            if (j === N.week)
                i[sb](i[db]() - i[Gb]() + q(d, 1));
            b = 1;
            if (Bb || hb)
                i = i.getTime(),
                    i = new ea(i + gb(i));
            h = i[kb]();
            for (var d = i.getTime(), l = i[jb](), m = i[db](), n = !g || !!hb, p = (N.day + (g ? gb(i) : i.getTimezoneOffset() * 6E4)) % N.day; d < c; )
                e.push(d),
                    j === N.year ? d = rb(h + b * k, 0) : j === N.month ? d = rb(h, l + b * k) : n && (j === N.day || j === N.week) ? d = rb(h, l, m + b * k * (j === N.day ? 1 : 7)) : d += j * k,
                    b++;
            e.push(d);
            o(Ha(e, function(a) {
    ...
    J.prototype.normalizeTimeTickInterval = function(a, b) {
        var c = b || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week", [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]], d = c[c.length - 1], e = N[d[0]], f = d[1], g;
        for (g = 0; g < c.length; g++)
            if (d = c[g],
                e = N[d[0]],
                f = d[1],
            c[g + 1] && a <= (e * f[f.length - 1] + N[c[g + 1][0]]) / 2)
                break;
        e === N.year && a < 5 * e && (f = [1, 2, 5]);
        c = Db(a / e, f, d[0] === "year" ? y(Cb(a / e), 1) : 1);
        return {
            unitRange: e,
            count: c,
            unitName: d[0]
    ...
    J.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        if (a >= 0.5)
            ...
            for (var f = Y(b), j, k, l, m, n, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !n; f++) {
                k = e.length;
                for (j = 0; j < k && !n; j++)
                    l = h(g(f) * e[j]),
                    l > b && (!d || m <= c) && m !== x && i.push(m),
                    m > c && (n = !0),
                        m = l
            }
        else if (b = g(b),
            ...
            a = Db(a, null, Cb(a)),
            i = wa(this.getLinearTickPositions(a, b, c), h),
            !d)
    ...
    Nb.prototype = {
        ...
        refresh: function(a, b) {
            ...
            f = h[0];
            g = h[1];
            m && (!a.series || !a.series.noSharedTooltip) ? (c.hoverPoints = a,
            i && o(i, function(a) {
                a.setState()
            }),
                o(a, function(a) {
            ...
            j === !1 ? this.hide() : (this.isHidden && (Qa(d),
    ...
    var ra;
    $a = C && C.documentElement.ontouchstart !== x;
    var ab = B.Pointer = function(a, b) {
            this.init(a, b)
        }
    ;
    ab.prototype = {
        init: function(a, b) {
            var c = b.chart, d = c.events, e = ua ? "" : c.zoomType, c = a.inverted, f;
            this.options = b;
            this.chart = a;
            ...
            if (B.Tooltip && b.tooltip.enabled)
                a.tooltip = new Nb(a,b.tooltip),
                    this.followTouchMove = q(b.tooltip.followTouchMove, !0);
            this.setDOMEvents()
        },
        normalize: function(a, b) {
            ...
            if (!b)
                this.chartPosition = b = Mb(this.chart.container);
            d.pageX === x ? (c = y(a.x, a.clientX - b.left),
        ...
        runPointActions: function(a) {
            ...
            g && (e ? g.noSharedTooltip : g.directTouch) && f ? m = [f] : (o(c, function(b) {
                ...
                k = !e && b.directTouch;
                b.visible && !j && !k && q(b.options.enableMouseTracking, !0) && (n = b.searchPoint(a, !j && b.kdDimensions === 1)) && n.series && l.push(n)
            }),
                o(l, function(a) {
            ...
            if (!this._onDocumentMouseMove)
                this._onDocumentMouseMove = function(a) {
                    if (ca[ra])
                        ca[ra].pointer.onDocumentMouseMove(a)
                }
                    ,
                    G(C, "mousemove", this._onDocumentMouseMove);
            ...
            if (!m || !m.touch)
                ...
                this.hasDragged > 10) {
                    ...
                    if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !r && !m)
                        this.selectionMarker = m = b.renderer.rect(h, i, f ? 1 : j, g ? 1 : k, 0).attr({
        ...
        onContainerMouseMove: function(a) {
            var b = this.chart;
            if (!t(ra) || !ca[ra] || !ca[ra].mouseIsDown)
                ra = b.index;
            a = this.normalize(a);
            a.returnValue = !1;
        ...
        onContainerClick: function(a) {
            var b = this.chart
                ...
                , e = b.plotTop
                , a = this.normalize(a);
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (K(c.series, "click", v(a, {
                point: c
            })),
            b.hoverPoint && c.firePointEvent("click", a)) : (v(a, this.getCoordinates(a)),
        ...
        setDOMEvents: function() {
            ...
            mb === 1 && G(C, "mouseup", a.onDocumentMouseUp);
            if ($a)
        ...
        destroy: function() {
            ...
            mb || (U(C, "mouseup", this.onDocumentMouseUp),
                U(C, "touchend", this.onDocumentTouchEnd));
    ...
    v(B.Pointer.prototype, {
        ...
        pinchTranslateDirection: function(a, b, c, d, e, f, g, h) {
            var i = this.chart, j = a ? "x" : "y", k = a ? "X" : "Y", l = "chart" + k, m = a ? "width" : "height", n = i["plot" + (a ? "Left" : "Top")], p, r, s = h || 1, q = i.inverted, o = i.bounds[a ? "h" : "v"], w = b.length === 1, F = b[0][l], L = c[0][l], t = !w && b[1][l], y = !w && c[1][l], x, c = function() {
                !w && T(F - t) > 20 && (s = h || T(L - y) / T(F - t));
                r = (n - L) / s + F;
        ...
        touch: function(a, b) {
            ...
            if (a.touches.length === 1)
                ...
                c.isInsidePlot(a.chartX - c.plotLeft, a.chartY - c.plotTop) && !c.openMenu) {
    ...
    if (M.PointerEvent || M.MSPointerEvent) {
        var Ia = {}
            ...
            , Pb = function(a, b, c, d) {
            if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && ca[ra])
                d(a),
                    d = ca[ra].pointer,
                    d[b]({
                        type: c,
        ...
        v(ab.prototype, {
            ...
            onContainerPointerMove: function(a) {
                Pb(a, "onContainerTouchMove", "touchmove", function(a) {
                    ...
                    if (!Ia[a.pointerId].target)
                        Ia[a.pointerId].target = a.currentTarget
                })
            },
            ...
            batchMSEvents: function(a) {
                a(this.chart.container, Ob ? "pointerdown" : "MSPointerDown", this.onContainerPointerDown);
                a(this.chart.container, Ob ? "pointermove" : "MSPointerMove", this.onContainerPointerMove);
                a(C, Ob ? "pointerup" : "MSPointerUp", this.onDocumentPointerUp)
            }
        });
        S(ab.prototype, "init", function(a, b, c) {
            a.call(this, b, c);
            this.hasZoom && O(b.container, {
    ...
    xb.prototype = {
        ...
        setText: function(a) {
            var b = this.options;
            a.legendItem.attr({
                text: b.labelFormat ? Ma(b.labelFormat, a) : b.labelFormatter.call(a)
            })
        },
        renderItem: function(a) {
            ...
            if (!s) {
                ...
                a.legendItem = s = c.text("", l ? f + g : -g, this.baseline || 0, w).css(D(a.visible ? h : i)).attr({
                    align: l ? "left" : "right",
                    zIndex: 2
                }).add(a.legendGroup);
                if (!this.baseline)
                    this.fontMetrics = c.fontMetrics(h.fontSize, s),
                        this.baseline = this.fontMetrics.f + 3 + p,
                        s.attr("y", this.baseline);
                o.drawLegendSymbol(this, a);
                this.setItemEvents && this.setItemEvents(a, s, w, h, i);
            ...
            e ? this.itemX += f : (this.itemY += p + g + n,
                this.lastLineHeight = g);
            this.offsetWidth = m || y((e ? this.itemX - r - k : f) + j, this.offsetWidth)
        },
        getAllItems: function() {
            var a = [];
            o(this.chart.series, function(b) {
                var c = b.options;
                if (q(c.showInLegend, !t(c.linkedTo) ? x : !1, !0))
        ...
        adjustMargins: function(a, b) {
            ...
            d.floating || o([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function(f, g) {
        ...
        handleOverflow: function(a) {
            var b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + (e.verticalAlign === "top" ? -f : f) - this.padding, g = e.maxHeight, h, i = this.clipRect, j = e.navigation, k = q(j.animation, !0), l = j.arrowSize || 12, m = this.nav, n = this.pages, p = this.padding, r, s = this.allItems, Z = function(a) {
                i.attr({
                    height: a
                });
            ...
            n.length = 0;
            if (a > f && j.enabled !== !1) {
                this.clipHeight = h = y(f - 20 - this.titleHeight - p, 0);
                ...
                if (!i)
                    i = b.clipRect = d.clipRect(0, p, 9999, 0),
    ...
    da = B.LegendSymbolMixin = {
        ...
        drawLineMarker: function(a) {
            ...
            if (b.lineWidth) {
                ...
                this.legendLine = e.path([W, 0, a, R, d, a]).attr(g).add(f)
            }
            if (c && c.enabled !== !1)
                b = c.radius,
    ...
    Da.prototype = {
        ...
        init: function(a, b) {
            ...
            f.xAxis = [];
            f.yAxis = [];
            f.animation = ua ? !1 : q(d.animation, !0);
            f.pointCount = f.colorCounter = f.symbolCounter = 0;
            f.firstRender()
        },
        initSeries: function(a) {
            var b = this.options.chart;
            (b = I[a.type || b.type || b.defaultSeriesType]) || ja(17, !0);
            b = new b;
            b.init(this, a);
            return b
        },
            ...
            i && (o(b, function(a) {
                ...
                o(b, function(a) {
                    ...
                    if (a.extKey !== b)
                        a.extKey = b,
                            p.push(function() {
                                K(a, "afterSetExtremes", v(a.eventArgs, a.getExtremes()));
                                delete a.eventArgs
                            });
                    (j || g) && a.redraw()
                }));
        ...
        getChartSize: function() {
            ...
            if (!t(b))
                this.containerWidth = ya(c, "width");
            if (!t(a))
                this.containerHeight = ya(c, "height");
            this.chartWidth = y(0, b || this.containerWidth || 600);
            this.chartHeight = y(0, q(a, this.containerHeight > 19 ? this.containerHeight : 400))
        },
        ...
        getContainer: function() {
            ...
            a || ja(13, !0);
            d = H($(a, "data-highcharts-chart"));
            z(d) && ca[d] && ca[d].hasRendered && ca[d].destroy();
            $(a, "data-highcharts-chart", this.index);
            a.innerHTML = "";
            !c.skipClone && !a.offsetWidth && this.cloneRenderTo();
            this.getChartSize();
            d = this.chartWidth;
            e = this.chartHeight;
            this.container = a = ia(Xa, {
            ...
            this.renderer = new (B[c.renderer] || Za)(a,d,e,c.style,c.forExport,b.exporting && b.exporting.allowHTML);
            ua && this.renderer.create(this, a, d, e);
        ...
        getMargins: function(a) {
            ...
            this.resetMargins();
            if (d && !t(c[0]))
                this.plotTop = y(this.plotTop, d + this.options.title.margin + b[0]);
        ...
        reflow: function(a) {
            var b = this
                ...
                , d = b.renderTo
                , e = t(c.width)
                , f = c.width || ya(d, "width")
                , c = c.height || ya(d, "height")
                , d = a ? a.target : M;
            if (!e && !b.isPrinting && f && c && (d === M || d === C)) {
                if (f !== b.containerWidth || c !== b.containerHeight)
                    clearTimeout(b.reflowTimeout),
                        b.reflowTimeout = bb(function() {
        ...
        setChartSize: function(a) {
            ...
            this.plotWidth = k = y(0, A(d - i - this.marginRight));
            this.plotHeight = l = y(0, A(e - j - this.marginBottom));
            ...
            d = 2 * Y(this.plotBorderWidth / 2);
            b = Ga(y(d, h[3]) / 2);
            c = Ga(y(d, h[0]) / 2);
            this.clipBox = {
                x: b,
                y: c,
                width: Y(this.plotSizeX - y(d, h[1]) / 2 - b),
                height: y(0, Y(this.plotSizeY - y(d, h[2]) / 2 - c))
            };
        ...
        drawChartBox: function() {
            ...
            if (k)
                f ? f.animate(o) : this.plotBackground = b.rect(p, r, s, q, 0).attr({
                    fill: k
            ...
            o(b, function(b) {
                ...
                if (Ea(d) && (d = d === ":previous" ? a.series[b.index - 1] : a.get(d)))
                    d.linkedSeries.push(b),
                        b.linkedParent = d,
                        b.visible = q(b.options.visible, d.options.visible, b.visible)
            })
        },
        ...
        isReadyToRender: function() {
            var a = this;
            return !ma && M == M.top && C.readyState !== "complete" || ua && !M.canvg ? (ua ? Zb.push(function() {
                a.firstRender()
    ...
    var ec = B.CenteredSeriesMixin = {
        getCenter: function() {
            var a = this.options, b = this.chart, c = 2 * (a.slicedOffset || 0), d = b.plotWidth - 2 * c, b = b.plotHeight - 2 * c, e = a.center, e = [q(e[0], "50%"), q(e[1], "50%"), a.size || "100%", a.innerSize || 0], f = E(d, b), g, h;
            for (g = 0; g < 4; ++g)
                h = e[g],
                    a = g < 2 || g === 2 && /%$/.test(h),
    ...
    Ja.prototype = {
        ...
        applyOptions: function(a, b) {
            ...
            if (d)
                this.y = this[d];
            this.isNull = this.x === null || !z(this.y, !0);
            if (this.x === void 0 && c)
    ...
    P.prototype = {
        ...
        autoIncrement: function(a) {
            var g;
            var b = this.options, c = this.xIncrement, d = b.pointIntervalUnit, e = this.xAxis, f, c = q(c, b.pointStart, 0);
            this.pointInterval = b = q(this.pointInterval, b.pointInterval, 1);
            if (e && e.categories && a.name)
                if (this.requireSorting = !1,
                    g = (f = Ra(e.categories)) ? e.categories : e.names,
                    e = g,
                    a = qa(a.name, e),
                a === -1) {
                    if (!f)
                    ...
                    c = a;
            d && (a = new ea(c),
                d === "day" ? a = +a[sb](a[db]() + b) : d === "month" ? a = +a[Hb](a[jb]() + b) : d === "year" && (a = +a[Ib](a[kb]() + b)),
                b = a - c);
            this.xIncrement = c + b;
            return c
        },
        setOptions: function(a) {
            ...
            this.userOptions = a;
            c = D(e, c.series, a);
            this.tooltipOptions = D(Q.tooltip, Q.plotOptions[this.type].tooltip, b.tooltip, d.series && d.series.tooltip, d[this.type] && d[this.type].tooltip, a.tooltip);
        ...
        getCyclic: function(a, b, c) {
            var d = this.userOptions
                , e = "_" + a + "Index"
                , f = a + "Counter";
            b || (t(d[e]) ? b = d[e] : (d[e] = b = this.chart[f] % c.length,
                this.chart[f] += 1),
                b = c[b]);
            this[a] = b
        },
        ...
        drawLegendSymbol: da.drawLineMarker,
        setData: function(a, b, c, d) {
            var e = this, f = e.points, g = f && f.length || 0, h, i = e.options, j = e.chart, k = null, l = e.xAxis, m = i.turboThreshold, n = this.xData, p = this.yData, r = (h = e.pointArrayMap) && h.length, a = a || [];
            h = a.length;
            b = q(b, !0);
        ...
        processData: function(a) {
            ...
            if (l && this.sorted && !k && (!i || d > i || this.forceCrop))
                if (b[d - 1] < n || b[0] > p)
                    b = [],
                        c = [];
                else if (b[0] < n || b[d - 1] > p)
                    e = this.cropData(this.xData, this.yData, n, p),
                        b = e.xData,
                        c = e.yData,
                        e = e.start,
                        f = !0;
            for (i = b.length || 1; --i; )
                d = m ? j(b[i]) - j(b[i - 1]) : b[i] - b[i - 1],
                    d > 0 && (g === x || d < g) ? g = d : d < 0 && this.requireSorting && ja(15);
            this.cropped = f;
            this.cropStart = e;
        ...
        generatePoints: function() {
            ...
            for (m = 0; m < g; m++)
                i = h + m,
                    j ? (l[m] = (new f).init(this, [d[m]].concat(sa(e[m]))),
                        l[m].dataGroup = this.groupMap[m]) : (b[i] ? k = b[i] : a[i] !== x && (b[i] = k = (new f).init(this, a[i], d[m])),
                        l[m] = k),
                    l[m].index = i;
            if (b && (g !== (c = b.length) || j))
                for (m = 0; m < c; m++)
        ...
        getExtremes: function(a) {
            ...
            for (l = 0; l < d; l++)
                if (j = c[l],
                    ...
                    j = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[l + 1] || j) >= g && (c[l - 1] || j) <= h,
                i && j)
                    if (i = k.length)
                        for (; i--; )
                            k[i] !== null && (e[f++] = k[i]);
        ...
        translate: function() {
            ...
            this.generatePoints();
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === "between" || z(i), k = a.threshold, l = a.startFromThreshold ? k : 0, m, n, p, r, s = Number.MAX_VALUE, a = 0; a < g; a++) {
                var o = f[a]
                    , u = o.x
                    , w = o.y;
                n = o.low;
                var F = b && e.stacks[(this.negStacks && w < (l ? 0 : k) ? "-" : "") + this.stackKey], L;
                if (e.isLog && w !== null && w <= 0)
                    o.y = w = null,
                        ja(10);
                o.plotX = m = V(E(y(-1E5, c.translate(u, 0, 0, 0, 1, i, this.type === "flags")), 1E5));
                if (b && this.visible && !o.isNull && F && F[u])
                    r = this.getStackIndicator(r, u, this.index),
                        L = F[u],
                        w = L.points[r.key],
                        n = w[0],
                        w = w[1],
                    n === l && r.key === F[u].base && (n = q(k, e.min)),
                    e.isLog && n <= 0 && (n = null),
                        o.total = o.stackTotal = L.total,
                        o.percentage = L.total && o.y / L.total * 100,
                        o.stackY = w,
                        L.setOffset(this.pointXOffset || 0, this.barW || 0);
                o.yBottom = t(n) ? e.translate(n, 0, 1, 0, 1) : null;
                h && (w = this.modifyValue(w, o));
                o.plotY = n = typeof w === "number" && w !== Infinity ? E(y(-1E5, e.translate(w, 0, 1, 0, 1)), 1E5) : x;
                o.isInside = n !== x && n >= 0 && n <= e.len && m >= 0 && m <= c.len;
                o.clientX = j ? V(c.translate(u, 0, 0, 0, 1)) : m;
                o.negative = o.y < (k || 0);
                o.category = d && d[o.x] !== x ? d[o.x] : o.x;
                o.isNull || (p !== void 0 && (s = E(s, T(m - p))),
                    p = m)
            }
                ...
                for (f = b.length; f--; )
                    ...
                    a && z(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || m,
                            ...
                            j = i.indexOf("url") === 0,
                            k)
                            k[r ? "show" : "hide"](!0).attr(a).animate(v({
                                x: d - h,
                                y: e - h
                            }, k.symbolName ? {
                                width: 2 * h,
        ...
        getAttribs: function() {
            var a = this, b = a.options, c = X[a.type].marker ? b.marker : b, d = c.states, e = d.hover, f, g = a.color, h = a.options.negativeColor, i = {
                stroke: g,
                fill: g
            ...
            var p = c.lineColor
                , r = c.fillColor;
            k = b.turboThreshold;
            var s = a.zones, Z = a.zoneAxis || "y", u, w;
            b.marker ? (e.radius = +e.radius || +c.radius + +e.radiusPlus,
                e.lineWidth = e.lineWidth || c.lineWidth + e.lineWidthPlus) : (e.color = e.color || xa(e.color || g).brighten(e.brightness).get(),
                e.negativeColor = e.negativeColor || xa(e.negativeColor || h).brighten(e.brightness).get());
                ...
                for (; g--; ) {
                    ...
                    if (f) {
                        ...
                        if (!b.marker || k.negative && !f.fillColor && !e.fillColor)
                            f[a.pointAttrToOptions.fill] = f.color || !k.options.color && e[k.negative && h ? "negativeColor" : "color"] || xa(k.color).brighten(f.brightness || e.brightness).get();
                        u = {
                            color: k.color
                        };
                        if (!r)
        ...
        destroy: function() {
            var a = this, b = a.chart, c = /AppleWebKit\/533/.test(Pa), d, e = a.data || [], f, g, h;
            K(a, "destroy");
            U(a);
            ...
            for (g in a)
                a[g]instanceof ba && !a[g].survive && (d = c && g === "group" ? "hide" : "destroy",
                    a[g][d]());
            if (b.hoverSeries === a)
                b.hoverSeries = null;
            Ba(b.series, a);
        ...
        getGraphPath: function(a, b, c) {
            ...
            o(a, function(g, l) {
                ...
                if ((g.leftCliff || p && p.rightCliff) && !c)
                    j = !0;
                g.isNull && !t(b) && l > 0 ? j = !e.connectNulls : g.isNull && !b ? j = !0 : (l === 0 || j ? p = [W, g.plotX, g.plotY] : d.getPointSpline ? p = d.getPointSpline(a, g, l) : f ? (p = f === 1 ? [R, p.plotX, n] : f === 2 ? [R, (p.plotX + m) / 2, p.plotY, R, (p.plotX + m) / 2, n] : [R, m, p.plotY],
                    p.push(R, m, n)) : p = [R, m, n],
                    i.push(g.x),
                f && i.push(g.x),
                    h.push.apply(h, p),
                    j = !1)
            ...
            o(c, function(c, h) {
                ...
                if (j)
                    ...
                    j = {
                        ...
                        j = a[i] = a.chart.renderer.path(f).attr(j).add(a.group).shadow(h < 2 && b.shadow);
                if (j)
                    j.startX = f.xMap,
                        j.isArea = f.isArea
            })
        ...
        applyZones: function() {
            var a = this, b = this.chart, c = b.renderer, d = this.zones, e, f, g = this.clips || [], h, i = this.graph, j = this.area, k = y(b.chartWidth, b.chartHeight), l = this[(this.zoneAxis || "y") + "Axis"], m, n = l.reversed, p = b.inverted, r = l.horiz, s, Z, u, w = !1;
            if (d.length && (i || j) && l.min !== x)
                i && i.hide(),
                j && j.hide(),
                    m = l.getExtremes(),
                    o(d, function(d, o) {
                        ...
                        e = E(y(q(f, e), 0), k);
                        f = E(y(A(l.toPixels(q(d.value, m.max), !0)), 0), k);
        ...
        render: function() {
            var a = this, b = a.chart, c, d = a.options, e = !!a.animate && b.renderer.isSVG && ib(d.animation).duration, f = a.visible ? "inherit" : "hidden", g = d.zIndex, h = a.hasRendered, i = b.seriesGroup;
            ...
            e && a.animate();
            if (!h)
                a.animationTimeout = bb(function() {
                    a.afterAnimate()
                }, e);
        ...
        searchKDTree: function(a, b) {
            function c(a, b, j, k) {
                ...
                p = t(a[e]) && t(l[e]) ? Math.pow(a[e] - l[e], 2) : null;
                n = t(a[f]) && t(l[f]) ? Math.pow(a[f] - l[f], 2) : null;
                n = (p || 0) + (n || 0);
                l.dist = t(n) ? Math.sqrt(n) : Number.MAX_VALUE;
                l.distX = t(p) ? Math.sqrt(p) : Number.MAX_VALUE;
                m = a[m] - l[m];
                n = m < 0 ? "left" : "right";
                p = m < 0 ? "right" : "left";
                b[n] && (n = c(a, b[n], j + 1, k),
                    r = n[g] < r[g] ? n : l);
                b[p] && Math.sqrt(m * m) < r[g] && (a = c(a, b[p], j + 1, k),
                    r = a[g] < r[g] ? a : r);
                return r
            }
            var d = this
    ...
    P.prototype.setStackedPoints = function() {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            var a = this.processedXData, b = this.processedYData, c = [], d = b.length, e = this.options, f = e.threshold, g = e.startFromThreshold ? f : 0, h = e.stack, e = e.stacking, i = this.stackKey, j = "-" + i, k = this.negStacks, l = this.yAxis, m = l.stacks, n = l.oldStacks, p, r, s, o, u, w, F;
            l.stacksTouched += 1;
            for (u = 0; u < d; u++) {
                w = a[u];
                F = b[u];
                p = this.getStackIndicator(p, w, this.index);
                o = p.key;
                s = (r = k && F < (g ? 0 : f)) ? j : i;
                m[s] || (m[s] = {});
                if (!m[s][w])
                    n[s] && n[s][w] ? (m[s][w] = n[s][w],
                        m[s][w].total = null) : m[s][w] = new Vb(l,l.options.stackLabels,r,w,h);
                s = m[s][w];
                if (F !== null) {
                    s.points[o] = s.points[this.index] = [q(s.cum, g)];
                    if (!t(s.cum))
                        s.base = o;
                    s.touched = l.stacksTouched;
                    p.index > 0 && this.singleStacks === !1 && (s.points[o][0] = s.points[this.index + "," + w + ",0"][0])
                }
                e === "percent" ? (r = r ? i : j,
                    k && m[r] && m[r][w] ? (r = m[r][w],
                        s.total = r.total = y(r.total, s.total) + T(F) || 0) : s.total = V(s.total + (T(F) || 0))) : s.total = V(s.total + (F || 0));
                s.cum = q(s.cum, g) + (F || 0);
                if (F !== null)
                    s.points[o].push(s.cum),
                        c[u] = s.cum
            }
            if (e === "percent")
                l.usePercentage = !0;
    ...
    v(Da.prototype, {
        ...
        showLoading: function(a) {
            ...
            if (!d)
                b.loadingDiv = d = ia(Xa, {
                    className: "highcharts-loading"
                }, v(e.style, {
                    zIndex: 10,
                    display: "none"
                }), b.container),
                    b.loadingSpan = ia("span", null, e.labelStyle, d),
                    G(b, "redraw", f);
    ...
    v(Ja.prototype, {
        update: function(a, b, c, d) {
            function e() {
                ...
                if (l && f.name)
                    l[f.x] = f.name;
                k.data[i] = ha(k.data[i], !0) ? f.options : a;
    ...
    var Aa = oa(P, {
                        ...
                        a.push(f[g]),
                            o([-1, 1], function(a) {
                                ...
                                if (n)
                                    for (m = h; m >= 0 && m < j; )
                                        q = n.points[m],
                                        q || (m === h ? f[g][c] = !0 : k[m] && (u = e[g].points[m]) && (d -= u[1] - u[0])),
                                            m += l;
        ...
        drawGraph: function() {
            ...
            o(d, function(d) {
                ...
                d[2] || (g["fill-opacity"] = q(c.fillOpacity, 0.75)),
                    g = a[f] = a.chart.renderer.path(b).attr(g).add(a.group),
                    g.isArea = !0);
                g.startX = b.xMap;
                g.shiftUnit = c.step ? 2 : 1
            })
        },
        drawLegendSymbol: da.drawRectangle
    });
    I.area = Aa;
    X.spline = D(ga);
    Ka = oa(P, {
    ...
    I.spline = Ka;
    X.areaspline = D(X.area);
    Aa = Aa.prototype;
    Ka = oa(Ka, {
        type: "areaspline",
        getStackPoints: Aa.getStackPoints,
        getGraphPath: Aa.getGraphPath,
        setStackCliffs: Aa.setStackCliffs,
    ...
    Ka = oa(P, {
        ...
        translate: function() {
            ...
            b.inverted && (f -= 0.5);
            c.pointPadding && (j = Ga(j));
            P.prototype.translate.apply(a);
            o(a.points, function(c) {
                var d = E(q(c.yBottom, f), 9E4), h = 999 + T(d), h = E(y(-h, c.plotY), e.len + h), p = c.plotX + k, r = j, o = E(h, d), t, u = y(h, d) - o;
                T(u) < g && g && (u = g,
                    t = !e.reversed && !c.negative || e.reversed && c.negative,
                    o = T(o - f) > g ? d - g : f - (t ? g : 0));
                c.barX = p;
                c.pointWidth = i;
            ...
            o(a.points, function(h) {
                ...
                if (z(h.plotY) && h.y !== null)
                    f = h.shapeArgs,
                        ...
                        i ? (Qa(i),
                            i.attr(j).attr(g)[b.pointCount < e ? "animate" : "attr"](D(f))) : h.graphic = d[h.shapeType](f).attr(j).attr(g).add(h.group || a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
                else if (i)
                    h.graphic = i.destroy()
            })
        },
        animate: function(a) {
            ...
            if (ma)
                a ? (f.scaleY = 0.001,
                    a = E(c.pos + c.len, y(c.pos, c.toPixels(d.threshold))),
                    e ? f.translateX = a - c.len : f.translateY = a,
                    b.group.attr(f)) : (f[e ? "translateX" : "translateY"] = c.pos,
                    b.group.animate(f, v(ib(b.options.animation), {
                        step: function(a, c) {
                            b.group.attr({
                                scaleY: y(0.001, c.pos)
                            })
                        }
                    })),
                    b.animate = null)
    ...
    ga = {
        ...
        translate: function(a) {
            this.generatePoints();
            var b = 0, c = this.options, d = c.slicedOffset, e = d + c.borderWidth, f, g, h, i = c.startAngle || 0, j = this.startAngleRad = Ca / 180 * (i - 90), i = (this.endAngleRad = Ca / 180 * (q(c.endAngle, i + 360) - 90)) - j, k = this.points, l = c.dataLabels.distance, c = c.ignoreHiddenPoint, m, n = k.length, p;
            if (!a)
                this.center = a = this.getCenter();
            this.getX = function(b, c) {
                h = aa.asin(E((b - a[1]) / (a[2] / 2 + l), 1));
            ...
            for (m = 0; m < n; m++) {
                ...
                p.half = h < -Ca / 2 || h > Ca / 2 ? 1 : 0;
                p.angle = h;
                e = E(e, l / 2);
                p.labelPos = [a[0] + f + fa(h) * l, a[1] + g + na(h) * l, a[0] + f + fa(h) * e, a[1] + g + na(h) * e, a[0] + f, a[1] + g, l < 0 ? "center" : p.half ? "right" : "left", h]
            }
        },
        drawGraph: null,
        drawPoints: function() {
            ...
            o(a.points, function(j) {
                if (j.y !== null) {
                    ...
                    f && f.attr(c);
                    if (d)
                        d.setRadialReference(a.center).attr(g).animate(v(h, c));
                    else {
                        i = {
                            "stroke-linejoin": "round"
                        };
    ...
    P.prototype.drawDataLabels = function() {
        ...
        if (d.enabled || a._hasPointLabels)
            a.dlProcessOptions && a.dlProcessOptions(d),
                j = a.plotGroup("dataLabelsGroup", "data-labels", k && !h ? "hidden" : "visible", d.zIndex || 6),
            k && (j.attr({
                opacity: +h
            }),
            h || G(a, "afterAnimate", function() {
                ...
                g = d,
                o(e, function(e) {
                    var h, k = e.dataLabel, r, o, y = e.connector, u = !0, w, F = {};
                    ...
                    if (k && !h)
                        ...
                        h = d.rotation;
                        r = e.getLabelConfig();
                        i = d.format ? Ma(d.format, r) : d.formatter.call(r, d);
                        w.color = q(d.color, w.color, a.color, "black");
                        if (k)
                            if (t(i))
                                k.attr({
                                    text: i
                                ...
                                if (e.dataLabel = k = k.destroy(),
                                    y)
                                    e.connector = y.destroy()
                            }
                        else if (t(i)) {
                            k = {
                            ...
                            if (w.color === "contrast")
                                F.color = d.inside || d.distance < 0 || b.stacking ? l.getContrast(e.color || a.color) : "#000000";
                            if (c)
                                F.cursor = c;
                            for (o in k)
                                k[o] === x && delete k[o];
    ...
    P.prototype.alignDataLabel = function(a, b, c, d, e) {
        var f = this.chart
            ...
            , p = q(c.overflow, "justify") === "justify";
        if (n)
            d = v({
                x: g ? f.plotWidth - i : h,
                ...
                l ? (p = !1,
                    ...
                    h = (l + 720) % 360,
                    h = h > 180 && h < 360,
                    m === "left" ? g.y -= h ? j.height : 0 : m === "center" ? (g.x -= j.width / 2,
                        g.y -= j.height / 2) : m === "right" && (g.x -= j.width,
                        g.y -= h ? 0 : j.height)) : (b.align(c, null, d),
                    g = b.alignAttr),
                p ? this.justifyDataLabel(b, c, g, j, d, e) : q(c.crop, !0) && (n = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + j.width, g.y + j.height)),
            c.shape && !l && b.attr({
                anchorX: a.plotX,
                anchorY: a.plotY
            });
    ...
    if (I.pie)
        I.pie.prototype.drawDataLabels = function() {
            var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = q(e.connectorPadding, 10), g = q(e.connectorWidth, 1), h = d.plotWidth, i = d.plotHeight, j, k, l = q(e.softConnector, !0), m = e.distance, n = a.center, p = n[2] / 2, r = n[1], s = m > 0, t, u, w, F = [[], []], x, v, B, D, z, C = [0, 0, 0, 0], G = function(a, b) {
                return b.y - a.y
            };
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                for (D = 2; D--; ) {
                    var J = [], M = [], H = F[D], K = H.length, I;
                    if (K) {
                        a.sortByAngle(H, D - 0.5);
                        for (z = b = 0; !b && H[z]; )
                            b = H[z] && H[z].dataLabel && (H[z].dataLabel.getBBox().height || 21),
                                z++;
                        if (m > 0) {
                            u = E(r + p + m, d.plotHeight);
                            for (z = y(0, r - p - m); z <= u; z += b)
                                J.push(z);
                            u = J.length;
                            if (K > u) {
                                c = [].concat(H);
                            ...
                            for (z = 0; z < K; z++) {
                                ...
                                if (I < z && J[z] !== null)
                                    ...
                                    for (u < K - z + I && J[z] !== null && (I = u - K + z); J[I] === null; )
                                        I++;
                                M.push({
                                    i: I,
                                    y: J[I]
                        ...
                        for (z = 0; z < K; z++) {
                            ...
                            if (m > 0) {
                                if (u = M.pop(),
                                    I = u.i,
                                    v = u.y,
                                c > v && J[I + 1] !== null || c < v && J[I - 1] !== null)
                                    v = E(y(0, c), d.plotHeight)
                            } else
                                v = c;
                            x = e.justify ? n[0] + (D ? -1 : 1) * (p + m) : a.getX(v === r - p - m || v === r + p + m ? c : v, D);
                            t._attr = {
                                visibility: B,
                                align: w[6]
                            };
                            ...
                            if (this.options.size === null)
                                u = t.width,
                                    x - u < f ? C[3] = y(A(u - x + f), C[3]) : x + u > h - f && (C[1] = y(A(x + u - h + f), C[1])),
                                    v - b / 2 < 0 ? C[0] = y(A(-v + b / 2), C[0]) : v + b / 2 > i && (C[2] = y(A(v + b / 2 - i), C[2]))
                        }
                    }
                }
                if (Fa(C) === 0 || this.verifyDataLabelOverflow(C))
                    this.placeDataLabels(),
                    s && g && o(this.points, function(b) {
                        j = b.connector;
                        w = b.labelPos;
                        if ((t = b.dataLabel) && t._pos && b.visible)
                            B = t._attr.visibility,
                                x = t.connX,
                                v = t.connY,
                                k = l ? [W, x + (w[6] === "left" ? 5 : -5), v, "C", x, v, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], R, w[4], w[5]] : [W, x + (w[6] === "left" ? 5 : -5), v, R, w[2], w[3], R, w[4], w[5]],
                                j ? (j.animate({
                                    d: k
                                }),
            ...
            ,
            I.pie.prototype.alignDataLabel = va,
            I.pie.prototype.verifyDataLabelOverflow = function(a) {
                var b = this.center, c = this.options, d = c.center, e = c.minSize || 80, f = e, g;
                d[0] !== null ? f = y(b[2] - y(a[1], a[3]), e) : (f = y(b[2] - a[1] - a[3], e),
                    b[0] += (a[3] - a[1]) / 2);
                d[1] !== null ? f = y(E(f, b[2] - y(a[0], a[2])), e) : (f = y(E(f, b[2] - a[0] - a[2]), e),
                    b[1] += (a[0] - a[2]) / 2);
                f < b[2] ? (b[2] = f,
    ...
    (function(a) {
            ...
            b.prototype.hideOverlappingLabels = function(a) {
                ...
                for (e = 0; e < b; e++) {
                    ...
                    for (d = e + 1; d < b; ++d)
                        if (k = a[d],
                        j && k && j.placed && k.placed && j.newOpacity !== 0 && k.newOpacity !== 0 && (l = j.alignAttr,
                            m = k.alignAttr,
                            n = j.parentGroup,
                            p = k.parentGroup,
                            r = 2 * (j.box ? 0 : j.padding),
                            l = !(m.x + p.translateX > l.x + n.translateX + (j.width - r) || m.x + p.translateX + (k.width - r) < l.x + n.translateX || m.y + p.translateY > l.y + n.translateY + (j.height - r) || m.y + p.translateY + (k.height - r) < l.y + n.translateY)))
    ...
    var ob = B.TrackerMixin = {
        ...
        drawTrackerGraph: function() {
            var a = this
                ...
                , n = "rgba(192,192,192," + (ma ? 1.0E-4 : 0.002) + ")";
            if (e && !c)
                for (k = e + 1; k--; )
                    d[k] === W && d.splice(k + 1, 0, d[k + 1] - i, d[k + 2], R),
                    (k && d[k] === W || k === e) && d.splice(k, 0, R, d[k - 2] + i, d[k - 1]);
            j ? j.attr({
                d: d
    ...
    if (I.column)
        Ka.prototype.drawTracker = ob.drawTrackerPoint;
    if (I.pie)
        I.pie.prototype.drawTracker = ob.drawTrackerPoint;
    if (I.scatter)
        Aa.prototype.drawTracker = ob.drawTrackerPoint;
    v(xb.prototype, {
        ...
        pan: function(a, b) {
            ...
            o(b === "xy" ? [1, 0] : [1], function(b) {
                var b = c[b ? "xAxis" : "yAxis"][0]
                    ...
                    , i = i > h;
                if (b.series.length && (i || l > E(k.dataMin, k.min)) && (!i || j < y(k.dataMax, k.max)))
                    b.setExtremes(l, j, !1, !1, {
                        trigger: "pan"
                    }),
                        e = !0;
                c[d] = h
    ...
    v(Ja.prototype, {
        ...
        setState: function(a, b) {
            var c = Y(this.plotX), d = this.plotY, e = this.series, f = e.options.states, g = X[e.type].marker && e.options.marker, h = g && !g.enabled, i = g && g.states[a], j = i && i.enabled === !1, k = e.stateMarkerGraphic, l = this.marker || {}, m = e.chart, n = e.halo, p, a = a || "";
                ...
                if (this.graphic)
                    ...
                    if (a && i)
                        ...
                        k && k.currentSymbol !== l && (k = k.destroy()),
                            ...
                            e.stateMarkerGraphic = k = m.renderer.symbol(l, c - g, d - g, 2 * g, 2 * g).attr(p).add(e.markerGroup),
                                k.currentSymbol = l;
                    if (k)
    ...
    S(P.prototype, "init", function(a) {
        ...
        (b = this.xAxis) && b.options.ordinal && G(this, "updatedData", function() {
            delete b.ordinalIndex
        })
    });
    S(J.prototype, "getTimeTicks", function(a, b, c, d, e, f, g, h) {
        var i = 0, j, k, l = {}, m, n, p, o = [], q = -Number.MAX_VALUE, v = this.options.tickPixelInterval;
        if (!this.options.ordinal && !this.options.breaks || !f || f.length < 3 || c === x)
        ...
        a = k.info;
        if (h && a.unitRange <= N.hour) {
            j = o.length - 1;
            for (i = 1; i < j; i++)
                pa("%d", o[i]) !== pa("%d", o[i - 1]) && (l[o[i]] = "day",
                    m = !0);
            m && (l[o[0]] = "day");
            a.higherRanks = l
        }
        ...
        if (h && t(v)) {
            ...
            for (u = void 0; h--; )
                i = j[h],
                    d = u - i,
                    u && d < v * 0.8 && (m === null || d < m * 0.8) ? (l[o[h]] && !l[o[h + 1]] ? (d = h + 1,
                        u = i) : d = h,
                        o.splice(d, 1)) : u = i
        }
        return o
            ...
            if ((e = this.options.ordinal) || i) {
                o(this.series, function(c, d) {
                    if (c.visible !== !1 && (c.takeOrdinalPosition !== !1 || i))
                        if (b = b.concat(c.processedXData),
                            a = b.length,
                            b.sort(function(a, b) {
                                return a - b
                            }),
                ...
                c ? (this.ordinalPositions = b,
                    d = this.val2lin(y(f, b[0]), !0),
                    h = y(this.val2lin(E(g, b[b.length - 1]), !0), 1),
                    this.ordinalSlope = g = (g - f) / (h - d),
                    this.ordinalOffset = f - d * g) : this.ordinalPositions = this.ordinalSlope = this.ordinalOffset = x
            }
            this.isOrdinal = e && c;
            ...
            if (m.ordinalPositions) {
                if (T(f) > 1)
                    k && o(k, function(a) {
                        ...
                        f < 0 ? (k = m,
                            p = c.ordinalPositions ? c : m) : (k = c.ordinalPositions ? c : m,
                            p = m),
                        m = p.ordinalPositions,
                    h > m[m.length - 1] && m.push(h),
                        this.fixedRange = j - i,
                        f = c.toFixedRange(null, null, l.apply(k, [n.apply(k, [i, !0]) + f, !0]), l.apply(p, [n.apply(p, [j, !0]) + f, !0])),
                    f.min >= E(g.dataMin, i) && f.max <= y(h, j) && c.setExtremes(f.min, f.max, !0, !1, {
                        trigger: "pan"
                    }),
                        this.mouseDownX = d,
                        O(this.container, {
    ...
    P.prototype.gappedPath = function() {
        ...
        if (a && c > 0)
            for (; c--; )
                b[c + 1].x - b[c].x > this.closestPointRange * a && b.splice(c + 1, 0, {
                    isNull: !0
                });
    ...
    (function(a) {
        ...
        g(i.prototype, {
            ...
            isInAnyBreak: function(a, b) {
                ...
                if (e) {
                    for (; e--; )
                        this.isInBreak(c[e], a) && (f = !0,
                        g || (g = d(c[e].showPoints, this.isXAxis ? !1 : !0)));
                    h = f && b ? f && !g : f
                }
                return h
            }
            ...
            if (this.options.breaks) {
                ...
                this.setAxisTranslation = function(a) {
                    ...
                    for (m in b)
                        g = b[m],
                            f = g.repeat || Infinity,
                        d.isInBreak(g, j) && (j += g.to % f - j % f),
                        d.isInBreak(g, k) && (k -= k % f - g.from % f);
                    for (m in b) {
                        g = b[m];
                        l = g.from;
                        for (f = g.repeat || Infinity; l - f > j; )
                            l -= f;
                        for (; l < j; )
                            l += f;
                        for (; l < k; l += f)
        ...
        e(j.prototype, "generatePoints", function(a) {
            ...
            if (c && d && (c.options.breaks || d.options.breaks))
                for (; g--; )
                    if (f = e[g],
                        i = f.y === null && h === !1,
                    !i && (c.isInAnyBreak(f.x, !0) || d.isInAnyBreak(f.y, !0)))
                        e.splice(g, 1),
                ...
                f(e, function(c) {
                    ...
                    f(g, function(b) {
                        ...
                        if (i < b.from && o > b.to || i > b.from && o < b.from)
                            j = "pointBreak";
                        else if (i < b.from && o > b.from && o < b.to || i > b.from && o > b.to && o < b.from)
                            j = "pointInBreak";
                        j && h(a, j, {
                            point: c,
                            brk: b
    ...
    la.groupData = function(a, b, c, d) {
        var e = this.data, f = this.options.data, g = [], h = [], i = [], j = a.length, k, l, m = !!b, n = [[], [], [], []], d = typeof d === "function" ? d : Va[d], p = this.pointArrayMap, o = p && p.length, q, t = 0, u = 0;
        for (q = 0; q <= j; q++)
            if (a[q] >= c[0])
                break;
        for (; q <= j; q++) {
    ...
    la.processData = function() {
        ...
        this.hasProcessed = !0;
        if (fc.apply(this, arguments) !== !1 && c) {
    ...
    S(Nb.prototype, "tooltipFooterHeaderFormatter", function(a, b, c) {
        ...
        return i && i.options.type === "datetime" && f && z(b.key) ? (a = d.currentDataGrouping,
            f = f.dateTimeLabelFormats,
            a ? (i = f[a.unitName],
                a.count === 1 ? g = i[0] : (g = i[1],
                    h = i[2])) : !g && f && (g = this.getXDateFormat(b, e, i)),
            g = pa(g, b.key),
        h && (g += pa(h, b.key + a.totalRange - 1)),
            Ma(e[(c ? "footer" : "header") + "Format"], {
                point: v(b.point, {
                    key: g
                }),
                series: d
    ...
    S(la, "setOptions", function(a, b) {
        ...
        if ($b[d])
            f || (f = D(ic, $b[d])),
                c.dataGrouping = D(f, e.series && e.series.dataGrouping, e[d].dataGrouping, b.dataGrouping);
            ...
            o(a.points, function(k) {
                if (k.plotY !== x)
                    i = k.graphic,
                        ...
                        j = A(k.plotX) - f,
                        g = A(k.shapeArgs.width / 2),
                        h = ["M", j, A(k.yBottom), "L", j, A(k.plotY)],
                    k.open !== null && (d = A(k.plotOpen) + f,
                        h.push("M", j, d, "L", j - g, d)),
                    k.close !== null && (e = A(k.plotClose) + f,
    ...
    ga = oa(ga, {
        ...
        drawPoints: function() {
            ...
            o(a.points, function(o) {
                m = o.graphic;
                if (o.plotY !== x)
                    c = o.pointAttr[o.selected ? "selected" : ""] || d,
                        ...
                        g = aa.min(e, f),
                        h = aa.max(e, f),
                        p = A(o.shapeArgs.width / 2),
                        i = A(g) !== A(o.plotY),
                        j = h !== o.yBottom,
                        g = A(g) + k,
                        h = A(h) + k,
                        n = [],
                        n.push("M", l - p, h, "L", l - p, g, "L", l + p, g, "L", l + p, h, "Z", "M", l, g, "L", l, i ? A(o.plotY) : g, "M", l, h, "L", l, j ? A(o.yBottom) : h),
                        m ? m.attr(c).animate({
                            d: n
    ...
    I.flags = oa(I.column, {
            ...
            if (e && e.visible && i) {
                ...
                for (a = "plot" + a[0].toUpperCase() + a.substr(1); i-- && c[d]; )
                    ...
                    l.x <= e.x && l[a] !== void 0) {
                        if (e.x <= m)
                            e.plotY = l[a],
                            l.x < e.x && !g && (n = h[i + 1]) && n[a] !== x && (e.plotY += (e.x - l.x) / (n.x - l.x) * (n[a] - l[a]));
                        d--;
                        i++;
                        if (d < 0)
                            break
        ...
        drawPoints: function() {
            var a, b = this.pointAttr[""], c = this.points, d = this.chart, e = d.renderer, f, g, h = this.options, i = h.y, j, k, l, m, n, p, o = this.yAxis, s;
            for (k = c.length; k--; )
                if (l = c[k],
                    a = l.plotX > this.xAxis.len,
                    f = l.plotX,
                f > 0 && (f -= q(l.lineWidth, h.lineWidth) % 2),
                    m = l.stackIndex,
                    j = l.options.shape || h.shape,
                    g = l.plotY,
                g !== x && (g = l.plotY + i - (m !== x && m * h.stackDistance)),
                    n = m ? x : l.plotX,
                    p = m ? x : l.plotY,
                    m = l.graphic,
                g !== x && f >= 0 && !a)
                    a = l.pointAttr[l.selected ? "select" : ""] || b,
                        s = q(l.options.title, h.title, "A"),
                        m ? m.attr({
                            text: s
                        }).attr({
                            x: f,
                            ...
                            anchorX: n,
                            anchorY: p
                        }) : l.graphic = e.label(s, f, g, j, n, p, h.useHTML).css(D(h.style, l.style)).attr(a).attr({
                            align: j === "flag" ? "left" : "center",
                            width: h.width,
                            height: h.height
                        }).add(this.markerGroup).shadow(h.shadow),
                        l.tooltipPos = d.inverted ? [o.len + o.pos - d.plotLeft - g, this.xAxis.len - f] : [f, g];
                else if (m)
                    l.graphic = m.destroy()
        },
        drawTracker: function() {
            var a = this.points;
            ob.drawTrackerPoint.apply(this);
            o(a, function(b) {
                var c = b.graphic;
                c && G(c.element, "mouseover", function() {
    ...
    Q.scrollbar = D(!0, Wb, Q.scrollbar);
    tb.prototype = {
        render: function() {
            var a = this.renderer, b = this.options, c = b.trackBorderWidth, d = b.barBorderWidth, e = this.size, f;
            this.group = f = a.g("highcharts-scrollbar").attr({
                zIndex: b.zIndex,
                translateY: -99999
            }).add();
            this.track = a.rect().attr({
                height: e,
                width: e,
                y: -c % 2 / 2,
                x: -c % 2 / 2,
            ...
            this.scrollbarRifles = a.path(this.swapXY([W, -3, e / 4, R, -3, 2 * e / 3, W, 0, e / 4, R, 0, 2 * e / 3, W, 3, e / 4, R, 3, 2 * e / 3], b.vertical)).attr({
                stroke: b.rifleColor,
                "stroke-width": 1
            }).add(this.scrollbarGroup);
        ...
        position: function(a, b, c, d) {
            ...
            this.x = a;
            this.y = b + e.trackBorderWidth;
            this.width = c;
            this.xOffset = this.height = d;
            this.yOffset = g;
            f ? (this.width = this.yOffset = c = g = this.size,
                this.xOffset = b = 0,
                this.barWidth = d - c * 2,
        ...
        drawScrollbarButton: function(a) {
            ...
            c.push(f);
            b.rect(-0.5, -0.5, e + 1, e + 1, d.buttonBorderRadius, d.buttonBorderWidth).attr({
                stroke: d.buttonBorderColor,
                "stroke-width": d.buttonBorderWidth,
                fill: d.buttonBackgroundColor
            }).add(f);
            b.path(this.swapXY(["M", e / 2 + (a ? -1 : 1), e / 2 - 3, "L", e / 2 + (a ? -1 : 1), e / 2 + 3, "L", e / 2 + (a ? 2 : -2), e / 2], d.vertical)).attr({
        ...
        setRange: function(a, b) {
            var c = this.options, d = c.vertical, e, f, g, h = this.rendered && !this.hasDragged ? "animate" : "attr";
            if (t(this.barWidth))
                e = this.barWidth * Math.max(a, 0),
                    f = this.barWidth * Math.min(b, 1),
                    f = Math.max(V(f - e), c.minWidth),
                    e = Math.floor(e + this.xOffset + this.yOffset),
                    g = f / 2 - 0.5,
                    this.from = a,
                    this.to = b,
                    d ? (this.scrollbarGroup[h]({
                        translateY: e
                    }),
                        this.scrollbar[h]({
                            height: f
                        ...
                        this.scrollbarTop = e,
                        this.scrollbarLeft = 0) : (this.scrollbarGroup[h]({
                        translateX: e
                    }),
                        this.scrollbar[h]({
                            width: f
                        ...
                        this.scrollbarLeft = e,
                        this.scrollbarTop = 0),
                    f <= 12 ? this.scrollbarRifles.hide() : this.scrollbarRifles.show(!0),
                c.showFull === !1 && (a <= 0 && b >= 1 ? this.group.hide() : this.group.show()),
                    this.rendered = !0
        },
        initEvents: function() {
            var a = this;
            a.mouseMoveHandler = function(b) {
                var c = a.chart.pointer.normalize(b)
                    ...
                    , e = a.initPositions;
                if (a.grabbedCenter && (!b.touches || b.touches[0][d] !== 0))
                    c = {
                        chartX: (c.chartX - a.x - a.xOffset) / a.barWidth,
                        chartY: (c.chartY - a.y - a.yOffset) / a.barWidth
                    }[d],
                        d = a[d],
                        d = c - d,
                        a.hasDragged = !0,
            ...
            a.mouseDownHandler = function(b) {
                ...
                a.chartX = (b.chartX - a.x - a.xOffset) / a.barWidth;
                a.chartY = (b.chartY - a.y - a.yOffset) / a.barWidth;
        ...
        addEvents: function() {
            var a = this.options.inverted ? [1, 0] : [0, 1]
                ...
                , a = [[b[a[0]].element, "click", this.buttonToMinClick], [b[a[1]].element, "click", this.buttonToMaxClick], [this.track.element, "click", this.trackClick], [c, "mousedown", d], [C, "mousemove", e], [C, "mouseup", f]];
            $a && a.push([c, "touchstart", d], [C, "touchmove", e], [C, "touchend", f]);
            o(a, function(a) {
                G.apply(null, a)
            });
            this._events = a
        ...
        destroy: function() {
            this.removeEvents();
            o([this.track, this.scrollbarRifles, this.scrollbar, this.scrollbarGroup, this.group], function(a) {
    ...
    S(J.prototype, "init", function(a) {
        ...
        if (b.options.scrollbar && b.options.scrollbar.enabled)
            b.options.scrollbar.vertical = !b.horiz,
                b.options.startOnTick = b.options.endOnTick = !1,
                b.scrollbar = new tb(b.chart.renderer,b.options.scrollbar,b.chart),
                G(b.scrollbar, "changed", function(a) {
                    var d = Math.min(q(b.options.min, b.min), b.min, b.dataMin), e = Math.max(q(b.options.max, b.max), b.max, b.dataMax) - d, f;
                    b.horiz && !b.reversed || !b.horiz && b.reversed ? (f = d + e * this.to,
                        d += e * this.from) : (f = d + e * (1 - this.from),
                        d += e * (1 - this.to));
                    b.setExtremes(d, f, !0, !1, a)
                })
    });
    S(J.prototype, "render", function(a) {
        var b = Math.min(q(this.options.min, this.min), this.min, this.dataMin), c = Math.max(q(this.options.max, this.max), this.max, this.dataMax), d = this.scrollbar, e;
        a.apply(this, [].slice.call(arguments, 1));
        d && (this.horiz ? d.position(this.left, this.top + this.height + this.offset + 2 + (this.opposite ? 0 : this.axisTitleMargin), this.width, this.height) : d.position(this.left + this.width + 2 + this.offset + (this.opposite ? this.axisTitleMargin : 0), this.top, this.width, this.height),
            isNaN(b) || isNaN(c) || !t(this.min) || !t(this.max) ? d.setRange(0, 0) : (e = (this.min - b) / (c - b),
                b = (this.max - b) / (c - b),
    ...
    v(Q, {
        navigator: {
            ...
            outlineWidth: 1,
            series: {
                type: I.areaspline === x ? "line" : "areaspline",
                color: "#4572A7",
                compare: null,
                fillOpacity: 0.05,
                dataGrouping: {
    ...
    Jb.prototype = {
        drawHandle: function(a, b) {
            ...
            this.rendered || (e[b] = c.g("navigator-handle-" + ["left", "right"][b]).css({
                cursor: "ew-resize"
            }).attr({
                zIndex: 10 - b
            }).add(),
                g = c.rect(-4.5, 0, 9, 16, 0, 1).attr(f).add(e[b]),
                d.push(g),
                g = c.path(["M", -1.5, 4, "L", -1.5, 12, "M", 0.5, 4, "L", 0.5, 12]).attr(f).add(e[b]),
                d.push(g));
            e[b][this.rendered && !this.hasDragged ? "animate" : "attr"]({
        ...
        render: function(a, b, c, d) {
            ...
            var k = this.xAxis
                ...
                , u = n + s
                , w = this.rendered;
            if (z(a) && z(b) && (!this.hasDragged || t(c))) {
                this.navigatorLeft = g = q(k.left, e.plotLeft + j);
                this.navigatorWidth = h = q(k.len, e.plotWidth - 2 * j);
                this.scrollerLeft = i = g - j;
                this.scrollerWidth = j = j = h + 2 * j;
                c = q(c, k.translate(a));
                d = q(d, k.translate(b));
                if (!z(c) || T(c) === Infinity)
                    c = 0,
                ...
                if (!(k.translate(d, !0) - k.translate(c, !0) < e.xAxis[0].minRange)) {
                    this.zoomedMax = E(y(c, d, 0), h);
                    this.zoomedMin = E(y(this.fixedWidth ? this.zoomedMax - this.fixedWidth : E(c, d), 0), h);
                    this.range = this.zoomedMax - this.zoomedMin;
                    b = A(this.zoomedMax);
                    a = A(this.zoomedMin);
                    if (!w && p)
                        this.navigatorGroup = k = f.g("navigator").attr({
                            zIndex: 3
                        }).add(),
                            this.leftShade = f.rect().attr({
                                fill: l.maskFill
                            }).add(k),
                            l.maskInside ? this.leftShade.css({
                                cursor: "ew-resize"
                            ...
                            this.outline = f.path().attr({
                                "stroke-width": o,
                                stroke: l.outlineColor
                            }).add(k);
                    f = w && !this.hasDragged ? "animate" : "attr";
                    if (p) {
                        this.leftShade[f](l.maskInside ? {
                            x: g + a,
                            y: n,
                            width: b - a,
                            height: m
                        ...
                        this.outline[f]({
                            d: [W, i, u, R, g + a - s, u, g + a - s, u + v, R, g + b - s, u + v, R, g + b - s, u, i + j, u].concat(l.maskInside ? [W, g + a + s, u, R, g + b - s, u] : [])
                        });
                        this.drawHandle(a + s, 0);
                        this.drawHandle(b + s, 1)
                    }
                    if (this.scrollbar)
                        this.scrollbar.hasDragged = this.hasDragged,
                            this.scrollbar.position(this.scrollerLeft, this.top + (p ? this.height : -this.scrollbarHeight), this.scrollerWidth, this.scrollbarHeight),
        ...
        addEvents: function() {
            ...
            f = [[b, "mousedown", c], [b, "mousemove", d], [C, "mouseup", e]];
            $a && f.push([b, "touchstart", c], [b, "touchmove", d], [C, "touchend", e]);
            o(f, function(a) {
                G.apply(null, a)
            });
            this._events = f;
            this.series && G(this.series.xAxis, "foundExtremes", function() {
        ...
        removeBaseSeriesEvents: function() {
            this.navigatorEnabled && this.baseSeries && this.baseSeries.xAxis && this.navigatorOptions.adaptToUpdatedData !== !1 && (U(this.baseSeries, "updatedData", this.updatedDataHandler),
                U(this.baseSeries.xAxis, "foundExtremes", this.modifyBaseAxisExtremes))
        },
        init: function() {
            ...
            a.mouseDownHandler = function(d) {
                var d = b.pointer.normalize(d), e = a.zoomedMin, f = a.zoomedMax, h = a.top, j = a.scrollerLeft, k = a.scrollerWidth, l = a.navigatorLeft, o = a.navigatorWidth, q = a.scrollbarPad || 0, t = a.range, v = d.chartX, x = d.chartY, d = b.xAxis[0], y, z = lb ? 10 : 7;
                if (x > h && x < h + g)
                    if (aa.abs(v - e - l) < z)
                        a.grabbedLeft = !0,
                            a.otherHandlePos = f,
                            ...
                            b.fixedRange = null;
                    else if (aa.abs(v - f - l) < z)
                        a.grabbedRight = !0,
                            a.otherHandlePos = e,
                            a.fixedExtreme = d.min,
                            b.fixedRange = null;
                    else if (v > l + e - q && v < l + f + q)
                        a.grabbedCenter = v,
                            a.fixedWidth = t,
                            i = v - e;
                    else if (v > j && v < j + k) {
                        ...
                        if (f < 0)
                            ...
                            f = o - t,
                                y = a.getUnionExtremes().dataMax;
                        if (f !== e)
                            a.fixedWidth = t,
                                e = c.toFixedRange(f, f + t, null, y),
                                d.setExtremes(e.min, e.max, !0, null, {
                                    trigger: "navigator"
                                })
                    }
            }
            ...
            a.mouseMoveHandler = function(c) {
                var d = a.scrollbarHeight, e = a.navigatorLeft, f = a.navigatorWidth, g = a.scrollerLeft, h = a.scrollerWidth, j = a.range, k;
                if (!c.touches || c.touches[0].pageX !== 0) {
                    c = b.pointer.normalize(c);
                    k = c.chartX;
                    k < e ? k = e : k > g + h - d && (k = g + h - d);
                    if (a.grabbedLeft)
                        a.hasDragged = !0,
                            a.render(0, 0, k - e, a.otherHandlePos);
                    else if (a.grabbedRight)
                        a.hasDragged = !0,
                            a.render(0, 0, a.otherHandlePos, k - e);
                    else if (a.grabbedCenter)
                        a.hasDragged = !0,
                            k < i ? k = i : k > f + i - j && (k = f + i - j),
                            a.render(0, 0, k - i, k - i + j);
                    if (a.hasDragged && a.scrollbar && a.scrollbar.options.liveRedraw)
                        c.DOMType = c.type,
                            setTimeout(function() {
                                a.mouseUpHandler(c)
                            }, 0)
            ...
            a.mouseUpHandler = function(d) {
                var e, f, g = d.DOMEvent || d;
                if (a.hasDragged || d.trigger === "scrollbar") {
                    ...
                    t(e.min) && b.xAxis[0].setExtremes(e.min, e.max, !0, a.hasDragged ? !1 : null, {
                        trigger: "navigator",
                        triggerOp: "navigator-drag",
                        DOMEvent: g
                    })
                }
                if (d.DOMType !== "mousemove")
            ...
            a.navigatorEnabled ? (a.xAxis = c = new J(b,D({
                ...
                j || f.series.data ? a.addBaseSeries() : b.series.length === 0 && S(b, "redraw", function(c, d) {
                ...
                translate: function(a, c) {
                    var d = b.xAxis[0]
                        ...
                        , d = zb("max", d.options.max, f.dataMax) - h;
                    return c ? a * d / g + h : g * (a - h) / d
                },
                toFixedRange: J.prototype.toFixedRange
            };
            if (b.options.scrollbar.enabled)
                a.scrollbar = new tb(b.renderer,D(b.options.scrollbar, {
                    margin: a.navigatorEnabled ? 0 : 10
                }),b),
                    G(a.scrollbar, "changed", function(c) {
                        var d = a.navigatorWidth
                            , e = d * this.to;
                        d *= this.from;
                        a.hasDragged = a.scrollbar.hasDragged;
                        a.render(0, 0, d, e);
                        (b.options.scrollbar.liveRedraw || c.DOMType !== "mousemove") && setTimeout(function() {
                            a.mouseUpHandler(c)
                        })
                    });
            a.addBaseSeriesEvents();
        ...
        getUnionExtremes: function(a) {
            ...
            if (!a || b.dataMin !== null)
                f = {
                    dataMin: q(d && d.min, zb("min", e.min, b.dataMin, c.dataMin, c.min)),
                    dataMax: q(d && d.max, zb("max", e.max, b.dataMax, c.dataMax, c.max))
                };
            return f
        },
        ...
        addBaseSeriesEvents: function() {
            ...
            if (a && a.xAxis && this.navigatorOptions.adaptToUpdatedData !== !1)
                G(a, "updatedData", this.updatedDataHandler),
                    G(a.xAxis, "foundExtremes", this.modifyBaseAxisExtremes),
        ...
        modifyBaseAxisExtremes: function() {
            if (this.chart.scroller.baseSeries && this.chart.scroller.baseSeries.xAxis) {
                var a = this.chart.scroller, b = this.getExtremes(), c = b.dataMin, d = b.dataMax, b = b.max - b.min, e = a.stickToMin, f = a.stickToMax, g, h, i = a.series, j = !!this.setExtremes;
                if (!(this.eventArgs && this.eventArgs.trigger === "rangeSelectorButton") && (e && (h = c,
                    g = h + b),
                f && (g = d,
                e || (h = y(g - b, i && i.xData ? i.xData[0] : -Number.MAX_VALUE))),
                j && (e || f) && z(h)))
                    this.min = this.userMin = h,
        ...
        updatedDataHandler: function() {
            var a = this.chart.scroller
                , b = a.baseSeries
                , c = a.series;
            a.stickToMin = z(b.xAxis.min) && b.xAxis.min <= b.xData[0];
            a.stickToMax = Math.round(a.zoomedMax) >= Math.round(a.navigatorWidth);
            if (c && !a.hasNavigatorData)
                c.options.pointStart = b.xData[0],
                    c.setData(b.options.data, !1, null, !1)
        },
        destroy: function() {
            this.removeEvents();
            o([this.scrollbar, this.xAxis, this.yAxis, this.leftShade, this.rightShade, this.outline], function(a) {
                a && a.destroy && a.destroy()
            });
            this.xAxis = this.yAxis = this.leftShade = this.rightShade = this.outline = null;
            o([this.handles, this.elementsToDestroy], function(a) {
                Oa(a)
            })
        }
    };
    B.Navigator = Jb;
    S(J.prototype, "zoom", function(a, b, c) {
    ...
    Kb.prototype = {
        clickButton: function(a, b) {
            var c = this, d = c.selected, e = c.chart, f = c.buttons, g = c.buttonOptions[a], h = e.xAxis[0], i = e.scroller && e.scroller.getUnionExtremes() || h || {}, j = i.dataMin, k = i.dataMax, l, m = h && A(E(h.max, q(k, h.max))), n = g.type, p, i = g._range, r, s, t, u = g.dataGrouping;
            if (!(j === null || k === null || a === c.selected)) {
                e.fixedRange = i;
                if (u)
                    this.forcedDataGrouping = !0,
                        J.prototype.setDataGrouping.call(h || {
                            chart: this.chart
                        }, u, !1);
                if (n === "month" || n === "year")
                    if (h) {
                ...
                if (f[a])
                    f[a].setState(2),
                        c.lastSelected = a;
                h ? (h.setExtremes(l, m, q(b, 1), null, {
                    trigger: "rangeSelectorButton",
                    rangeSelectorButton: g
                }),
                    c.setSelected(a)) : (p = sa(e.options.xAxis)[0],
                    t = p.range,
                    p.range = i,
                    s = p.min,
                    p.min = r,
        ...
        init: function(a) {
            ...
            b.buttonOptions = d;
            G(a.container, "mousedown", f);
            G(a, "resize", f);
            o(d, b.computeButtonRange);
            e !== x && d[e] && this.clickButton(e, !1);
            G(a, "load", function() {
        ...
        updateButtonStates: function(a) {
            var b = this
                ...
                , j = b.buttons;
            a && c.fixedRange !== A(d.max - d.min) && (j[h] && j[h].setState(0),
                b.setSelected(null));
            o(b.buttonOptions, function(a, e) {
                ...
                if ((o === "month" || o === "year") && m >= {
                    ...
                    n = !0;
                v || n && e !== h && e === b.lastSelected ? (b.setSelected(e),
                    j[e].setState(2)) : !i && (s || t || u || w || x) ? j[e].setState(3) : j[e].state === 3 && j[e].setState(0)
            })
        },
        ...
        setInputValue: function(a, b) {
            ...
            this[a + "Input"].value = pa(c.inputEditDateFormat || "%Y-%m-%d", this[a + "Input"].HCTime);
            this[a + "DateBox"].attr({
                text: pa(c.inputDateFormat || "%b %e, %Y", this[a + "Input"].HCTime)
            })
        },
        ...
        drawInput: function(a) {
            function b() {
                ...
                if (b !== j.previousValue)
                    j.previousValue = b,
                    z(b) || (b = a.split("-"),
                        b = ea.UTC(H(b[0]), H(b[1]) - 1, H(b[2]))),
                    z(b) && (Q.global.useUTC || (b += (new ea).getTimezoneOffset() * 6E4),
                        i ? b > c.maxInput.HCTime ? b = x : b < f && (b = f) : b < c.minInput.HCTime ? b = x : b > h && (b = h),
                    b !== x && d.xAxis[0].setExtremes(i ? b : e.min, i ? e.max : b, x, x, {
            ...
            this[a + "Label"] = k = f.label(Q.lang[i ? "rangeSelectorFrom" : "rangeSelectorTo"], this.inputGroup.offset).attr({
                padding: 2
            }).css(D(e, g.labelStyle)).add(l);
            l.offset += k.width + 5;
        ...
        render: function(a, b) {
            var c = this, d = c.chart, e = d.renderer, f = d.container, g = d.options, h = g.exporting && g.exporting.enabled !== !1 && g.navigation && g.navigation.buttonOptions, i = g.rangeSelector, j = c.buttons, g = Q.lang, k = c.div, k = c.inputGroup, l = i.buttonTheme, m = i.buttonPosition || {}, n = i.inputEnabled, p = l && l.states, r = d.plotLeft, s, x = this.getPosition(), u = c.group, w = c.rendered;
            if (!w && (c.group = u = e.g("range-selector-buttons").add(),
                c.zoomText = e.text(g.rangeSelectorZoom, q(m.x, r), 15).css(i.labelStyle).add(u),
                s = q(m.x, r) + c.zoomText.getBBox().width + 5,
                o(c.buttonOptions, function(a, b) {
                    j[b] = e.button(a.text, s, 0, function() {
                        c.clickButton(b);
                        c.isActive = !0
                    }, l, p && p.hover, p && p.select, p && p.disabled).css({
                        textAlign: "center"
                    }).add(u);
            ...
            n !== !1 && (k.align(v({
                y: x.inputTop,
                width: k.offset,
                x: h && x.inputTop < (h.y || 0) + h.height - d.spacing[0] ? -40 : 0
            }, i.inputPosition), !0, d.spacingBox),
            t(n) || (d = u.getBBox(),
                k[k.translateX < d.x + d.width + 10 ? "hide" : "show"]()),
        ...
        destroy: function() {
            ...
            for (e in this)
                this[e] && e !== "chart" && (this[e].destroy ? this[e].destroy() : this[e].nodeType && Wa(this[e])),
                    this[e] = null
        }
    };
    ...
    J.prototype.minFromRange = function() {
        var a = this.range, b = {
            month: "Month",
            year: "FullYear"
        }[a.type], c, d = this.max, e, f, g = function(a, c) {
            var d = new ea(a);
            d["set" + b](d["get" + b]() + c);
            return d.getTime() - a
        };
        ...
        if (c <= e)
            c = e,
            f === void 0 && (f = g(c, a.count)),
                this.newMax = E(c + f, this.dataMax);
        z(d) || (c = void 0);
        return c
    }
    ;
    S(Da.prototype, "init", function(a, b, c) {
        G(this, "init", function() {
            if (this.options.rangeSelector.enabled)
                this.rangeSelector = new Kb(this)
        });
        a.call(this, b, c)
    });
    B.RangeSelector = Kb;
    Da.prototype.callbacks.push(function(a) {
        function b() {
            d = a.xAxis[0].getExtremes();
            z(d.min) && f.render(d.min, d.max)
        }
        function c(a) {
            f.render(a.min, a.max)
        }
        var d, e = a.scroller, f = a.rangeSelector;
        e && (d = a.xAxis[0].getExtremes(),
            e.render(d.min, d.max));
        f && (G(a.xAxis[0], "afterSetExtremes", c),
            G(a, "resize", b),
            b());
        G(a, "destroy", function() {
            f && (U(a, "resize", b),
                U(a.xAxis[0], "afterSetExtremes", c))
        })
    });
    B.StockChart = B.stockChart = function(a, b, c) {
        var d = Ea(a) || a.nodeName, e = arguments[d ? 1 : 0], f = e.series, g, h = q(e.navigator && e.navigator.enabled, !0) ? {
            startOnTick: !1,
            endOnTick: !1
        } : null, i = {
            marker: {
        ...
        e.xAxis = wa(sa(e.xAxis || {}), function(a) {
            return D({
                minPadding: 0,
                maxPadding: 0,
                ordinal: !0,
        ...
        e.series = f;
        return d ? new Da(a,e,c) : new Da(e,b)
    }
    ;
    S(ab.prototype, "init", function(a, b, c) {
    ...
    S(J.prototype, "getPlotLinePath", function(a, b, c, d, e, f) {
        var g = this, h = this.isLinked && !this.series ? this.linkedParent.series : this.series, i = g.chart, j = i.renderer, k = g.left, l = g.top, m, n, p, r, s = [], v = [], u, w;
        if (g.coll === "colorAxis")
            return a.apply(this, [].slice.call(arguments, 1));
        v = g.isXAxis ? t(g.options.yAxis) ? [i.yAxis[g.options.yAxis]] : wa(h, function(a) {
            return a.yAxis
        ...
        u = v.length ? [] : [g.isXAxis ? i.yAxis[0] : i.xAxis[0]];
        o(v, function(a) {
            qa(a, u) === -1 && u.push(a)
        });
        w = q(f, g.translate(b, null, null, d));
        z(w) && (g.horiz ? o(u, function(a) {
            var b;
            n = a.pos;
            r = n + a.len;
            m = p = A(w + g.transB);
            if (m < k || m > k + g.width)
                e ? m = p = E(y(k, m), k + g.width) : b = !0;
            ...
            n = r = A(l + g.height - w);
            if (n < l || n > l + g.height)
                e ? n = r = E(y(l, n), g.top + g.height) : b = !0;
            b || s.push("M", m, n, "L", p, r)
        }));
    ...
    za.prototype.crispPolyLine = function(a, b) {
        ...
        for (c = 0; c < a.length; c += 6)
            a[c + 1] === a[c + 4] && (a[c + 1] = a[c + 4] = A(a[c + 1]) - b % 2 / 2),
            a[c + 2] === a[c + 5] && (a[c + 2] = a[c + 5] = A(a[c + 2]) + b % 2 / 2);
        return a
    }
    ;
    if (Za === B.VMLRenderer)
        nb.prototype.crispPolyLine = za.prototype.crispPolyLine;
    S(J.prototype, "hideCrosshair", function(a, b) {
        a.call(this, b);
        if (this.crossLabel)
    ...
    S(J.prototype, "drawCrosshair", function(a, b, c) {
        ...
        if (t(this.crosshair.label) && this.crosshair.label.enabled && this.cross) {
            ...
            if (!k)
                k = this.crossLabel = a.renderer.label(null, null, null, f.shape || "callout").attr({
                    align: f.align || l,
                    zIndex: 12,
            ...
            g ? (l = r ? c.plotX + i : b.chartX,
                j += h ? 0 : this.height) : (l = h ? this.width + i : 0,
                j = r ? c.plotY + j : b.chartY);
            !m && !f.formatter && (this.isDatetimeAxis && (n = "%b %d, %Y"),
                m = "{value" + (n ? ":" + n : "") + "}");
            ...
            if (g) {
                ...
                j = k.y - b.height / 2;
            g ? (d = i - b.x,
                e = i + this.width - b.x) : (d = this.labelAlign === "left" ? i : 0,
    ...
    var jc = la.init
        , kc = la.processData
        , lc = Ja.prototype.tooltipFormatter;
    la.init = function() {
    ...
    la.setCompare = function(a) {
        this.modifyValue = a === "value" || a === "percent" ? function(b, c) {
                ...
                if (b !== x && (b = a === "value" ? b - d : b = 100 * (b / d) - 100,
                    c))
                    c.change = b;
                return b
            }
    ...
    la.processData = function() {
        ...
        if (this.xAxis && this.processedYData) {
            ...
            e = d.length;
            this.pointArrayMap && (b = qa(this.pointValKey || "y", this.pointArrayMap));
            for (a = 0; a < e - 1; a++)
                if (f = b > -1 ? d[a][b] : d[a],
                z(f) && c[a + 1] >= this.xAxis.min && f !== 0) {
                    this.compareValue = f;
                    break
                }
        }
    ...
    S(P.prototype, "render", function(a) {
        if (this.chart.options._stock && this.xAxis)
            !this.clipBox && this.animate ? (this.clipBox = D(this.chart.clipBox),
                this.clipBox.width = this.xAxis.len,
                this.clipBox.height = this.yAxis.len) : this.chart[this.sharedClipKey] && (Qa(this.chart[this.sharedClipKey]),
