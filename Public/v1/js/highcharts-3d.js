...
(function(d) {
        ...
        function w(f, a, b, c, e, g, d, i) {
            var h = [];
            return g > e && g - e > n / 2 + 1.0E-4 ? (h = h.concat(w(f, a, b, c, e, e + n / 2, d, i)),
                h = h.concat(w(f, a, b, c, e + n / 2, g, d, i))) : g < e && e - g > n / 2 + 1.0E-4 ? (h = h.concat(w(f, a, b, c, e, e - n / 2, d, i)),
                h = h.concat(w(f, a, b, c, e - n / 2, g, d, i))) : (h = g - e,
                ["C", f + b * m(e) - b * B * h * l(e) + d, a + c * l(e) + c * B * h * m(e) + i, f + b * m(g) + b * B * h * l(g) + d, a + c * l(g) - c * B * h * m(g) + i, f + b * m(g) + d, a + c * l(g) + i])
        }
        function D(f) {
            if (this.chart.is3d()) {
        ...
        d.SVGRenderer.prototype.cuboid = function(f) {
            ...
            ;
            a.attr = function(a) {
                a.shapeArgs || A(a.x) ? (a = this.renderer.cuboidPath(a.shapeArgs || a),
                    this.front.attr({
                        d: a[0],
                        zIndex: a[3]
                    }),
            ...
            a.animate = function(a, c, e) {
                A(a.x) && A(a.y) ? (a = this.renderer.cuboidPath(a),
                    this.front.attr({
                        zIndex: a[3]
                    }).animate({
                        d: a[0]
                    ...
                    this.side.attr({
                        ...
                        d: a[2]
                    }, c, e)) : a.opacity ? (this.front.animate(a, c, e),
                    this.top.animate(a, c, e),
                    this.side.animate(a, c, e)) : d.SVGElement.prototype.animate.call(this, a, c, e);
                return this
            }
            ;
            a.destroy = function() {
        ...
        d.SVGRenderer.prototype.arc3d = function(f) {
            ...
            a.animate = function(a, b, c) {
                A(a.end) || A(a.start) ? (this._shapeArgs = this.shapeArgs,
        ...
        d.wrap(d.Chart.prototype, "init", function(f) {
            ...
            if (a[0].chart.options3d && a[0].chart.options3d.enabled)
                b = a[0].plotOptions || {},
                    b = b.pie || {},
                    b.borderColor = d.pick(b.borderColor, void 0);
            f.apply(this, a)
        });
        ...
        d.wrap(d.Axis.prototype, "init", function(f) {
            var a = arguments;
            if (a[1].is3d())
                a[2].tickWidth = d.pick(a[2].tickWidth, 0),
                    a[2].gridLineWidth = d.pick(a[2].gridLineWidth, 1);
            f.apply(this, [].slice.call(arguments, 1))
        });
        ...
        d.wrap(d.seriesTypes.column.prototype, "animate", function(f) {
            if (this.chart.is3d()) {
                ...
                if (d.svg)
                    a ? d.each(c.data, function(a) {
                        if (a.y !== null && (a.height = a.shapeArgs.height,
                            a.shapey = a.shapeArgs.y,
                            a.shapeArgs.height = 1,
                            !e))
                            a.shapeArgs.y = a.stackY ? a.plotY + b.translate(a.stackY) : a.plotY + (a.negative ? -a.height : a.height)
        ...
        d.wrap(d.seriesTypes.column.prototype, "init", function(d) {
            ...
            if (this.chart.is3d()) {
                ...
                if ((b === void 0 || b) && c) {
                    ...
                    c = a.stack || 0;
                    for (e = 0; e < b[c].series.length; e++)
                        if (b[c].series[e] === this)
                            break;
        ...
        d.wrap(d.seriesTypes.pie.prototype, "animate", function(f) {
            if (this.chart.is3d()) {
                ...
                if (d.svg)
                    if (b === !0 && (b = {}),
                        a) {
                        if (e.oldtranslateX = e.translateX,
                            e.oldtranslateY = e.translateY,
                            a = {
                                translateX: c[0],
                                translateY: c[1],
                                scaleX: 0.001,
        ...
        if (d.VMLRenderer)
            d.setOptions({
                ...
                d.VMLRenderer.prototype.arc3d = function(f) {
                ...
                d.Chart.prototype.renderSeries = function() {
                    for (var d, a = this.series.length; a--; )
                        d = this.series[a],
                            d.translate(),
                        d.setTooltipPoints && d.setTooltipPoints(),
                            d.render()
                }
                ,
                d.wrap(d.Axis.prototype, "render", function(d) {
