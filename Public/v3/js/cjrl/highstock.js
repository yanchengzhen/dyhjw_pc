...
(function() {
                ...
                if (d) {
                    ...
                    if (f.length)
                        f = f.join(":"),
                            ...
                            e !== null && (e = Ka(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = wa(f, e)
                }
                j.push(e);
                a = a.slice(c + 1);
                c = (d = !d) ? "}" : "{"
        ...
        wa = function(a, b, c) {
            if (!t(b) || isNaN(b))
                return "Invalid date";
            var a = q(a, "%Y-%m-%d %H:%M:%S"), d = new Date(b - Na), e, f = d[yb](), g = d[zb](), h = d[Wa](), i = d[lb](), j = d[mb](), k = F.lang, l = k.weekdays, d = s({
                a: l[g].substr(0, 3),
                A: l[g],
                d: Sa(h),
                e: h,
                ...
                S.HighchartsAdapter = S.HighchartsAdapter || a && {
                    init: function(b) {
                        ...
                        a.each(["cur", "_default", "width", "height", "opacity"], function(a, b) {
                            var e = d, k;
                            b === "cur" ? e = c.prototype : b === "_default" && f && (e = g[b],
                                b = "set");
                            (k = e[b]) && (e[b] = function(c) {
                                    var d, c = a ? c : this;
                                    if (c.prop !== "align")
                                        return d = c.elem,
                                            d.attr ? d.attr(c.prop, b === "cur" ? r : c.now) : k.apply(this, arguments)
                                }
                            )
                        });
        ...
        Z.prototype = {
            ...
            init: function(a, b) {
                this.element = b === "span" ? aa(b) : D.createElementNS(Ga, b);
                this.renderer = a
            },
            ...
            colorGradient: function(a, b, c) {
                ...
                if (f) {
                    ...
                    f === "radialGradient" && m && !t(g.gradientUnits) && (g = x(g, {
                    ...
                    for (n in j)
                        o.push(j[n]);
                    o = o.join(",");
                    h[o] ? a = h[o].attr("id") : (g.id = a = "highcharts-" + Eb++,
                        h[o] = i = d.createElement(f).attr(g).add(d.defs),
                        i.stops = [],
                        p(j, function(a) {
                            a[1].indexOf("rgba") === 0 ? (e = Ha(a[1]),
                                k = e.get("rgb"),
                                l = e.get("a")) : (k = a[1],
                                l = 1);
            ...
            getBBox: function() {
                ...
                if (!a) {
                    ...
                    if (b.isSVG) {
                        c = a.width;
                        d = a.height;
                        if (Ja && f && f.fontSize === "11px" && d.toPrecision(3) === "16.9")
                            a.height = d = 14;
                        if (e)
                            a.width = P(d * ja(g)) + P(c * ea(g)),
                                a.height = P(d * ea(g)) + P(c * ja(g))
                    }
                    this.bBox = a;
                    h && (b.cache[h] = a)
                }
            ...
            show: function(a) {
                return a && this.element.namespaceURI === Ga ? (this.element.removeAttribute("visibility"),
                    this) : this.attr({
            ...
            titleSetter: function(a) {
                ...
                b || (b = D.createElementNS(Ga, "title"),
        ...
        la.prototype = {
            ...
            init: function(a, b, c, d, e) {
                ...
                this.boxWrapper = d;
                this.alignedObjects = [];
                this.url = (bb || Db) && D.getElementsByTagName("base").length ? f.href.replace(/#.*?$/, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
            ...
            buildText: function(a) {
                for (var b = a.element, c = this, d = c.forExport, e = q(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, j = Y(b, "x"), k = a.styles, l = a.textWidth, m = k && k.lineHeight, n = k && k.HcTextStroke, o = g.length, y = function(a) {
                    ...
                    b.removeChild(g[o]);
                !f && !n && e.indexOf(" ") === -1 ? b.appendChild(D.createTextNode(e)) : (h = /<.*style="([^"]+)".*>/,
                    i = /<.*href="(http[^"]+)".*>/,
                            ...
                            if (e !== "" || g.length === 1) {
                                ...
                                if (e !== " ") {
                                    ...
                                    !m && f && (!da && d && K(o, {
                                        ...
                                        Y(o, "dy", y(o)));
                                    if (l)
                                        for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), n = g.length > 1 || e.length > 1 && k.whiteSpace !== "nowrap", q, p, r = k.HcHeight, u = [], t = y(o), Tb = 1; n && (e.length || u.length); )
                                            delete a.bBox,
                                                q = a.getBBox(),
                                                p = q.width,
                                            !da && c.forExport && (p = c.measureSpanWidth(o.firstChild.data, a.styles)),
                                                q = p > l,
                                                !q || e.length === 1 ? (e = u,
                                                    u = [],
                                                e.length && (Tb++,
                                                    r && Tb * t > r ? (e = ["..."],
                                                        a.attr("title", a.textStr)) : (o = D.createElementNS(Ga, "tspan"),
                                                        Y(o, {
                                                            dy: t,
                                                            x: j
                                                        }),
                                                ...
                                                p > l && (l = p)) : (o.removeChild(o.firstChild),
                                                    u.unshift(e.pop())),
                                            e.length && o.appendChild(D.createTextNode(e.join(" ").replace(/- /g, "-")));
                                    m++
                                }
                            }
                        })
            ...
            button: function(a, b, c, d, e, f, g, h, i) {
                var j = this.label(a, b, c, i, null, null, null, null, "button"), k = 0, l, m, n, o, y, I, a = {
                    x1: 0,
                    y1: 0,
                    x2: 0,
                    y2: 1
            ...
            fontMetrics: function(a, b) {
                ...
                var a = /px/.test(a) ? G(a) : /em/.test(a) ? parseFloat(a) * 12 : 12
                    , c = a < 24 ? a + 4 : u(a * 1.2)
                    , d = u(c * 0.8);
                return {
                    h: c,
            ...
            label: function(a, b, c, d, e, f, g, h, i) {
                function j() {
                    ...
                    n.height = (Gb || I.height || 0) + 2 * w;
                    R = w + m.fontMetrics(a && a.fontSize, o).b;
                    if (z) {
                        if (!y)
                            a = u(-q * w),
                                b = h ? -R : 0,
                                n.box = y = d ? m.symbol(d, a, b, n.width, n.height, C) : m.rect(a, b, n.width, n.height, 0, C[Zb]),
                                y.attr("fill", $).add(n);
                        y.isImg || y.attr(s({
                            width: u(n.width),
                            height: u(n.height)
                ...
                var m = this, n = m.g(i), o = m.text("", 0, 0, g).attr({
                    zIndex: 1
                }), y, I, q = 0, w = 3, db = 0, v, Gb, O, Hb, A = 0, C = {}, R, z;
                n.onAdd = function() {
                    o.add(n);
                    n.attr({
                        text: a || "",
        ...
        s(Z.prototype, {
            ...
            setSpanRotation: function(a, b, c) {
                var d = {}
                    , e = Ja ? "-ms-transform" : Db ? "-webkit-transform" : bb ? "MozTransform" : Rb ? "-o-transform" : "";
        ...
        if (!da && !ka)
            fa = {
                    ...
                    if (a) {
                        ...
                        for (e = 1; e <= 3; e++) {
                            ...
                            h = aa(g.prepVML(j), null, {
                                left: G(i.left) + q(a.offsetX, 1),
                                top: G(i.top) + q(a.offsetY, 1)
                            });
                            if (c)
                                h.cutOff = l + 1;
                ...
                Q.VMLElement = fa = ha(Z, fa),
                fa.prototype.ySetter = fa.prototype.widthSetter = fa.prototype.heightSetter = fa.prototype.xSetter,
                fa = {
                    Element: fa,
                    ...
                    init: function(a, b, c, d) {
                        var e;
                        this.alignedObjects = [];
                        d = this.createElement(Va).css(s(this.getStyle(d), {
                            position: "relative"
                        }));
                        e = d.element;
                ...
                ,
                hb.prototype = x(la.prototype, fa),
                Ya = hb;
        ...
        ab.prototype = {
            ...
            render: function(a, b, c) {
                var d = this.axis
                    ...
                    , v = !0
                    , t = d.tickmarkOffset
                    , s = this.getPosition(g, j, t, b)
                    , x = s.x
                    , s = s.y
                    , C = g && x === d.pos + d.len || !g && s === d.pos ? -1 : 1
                    , c = q(c, 1);
                this.isActive = !0;
                if (o) {
                ...
                if (m && p)
                    db === "inside" && (p = -p),
                    d.opposite && (p = -p),
                        h = this.getMarkPath(x, s, p, m * C, g, f),
                        n ? n.animate({
                            d: h,
                            opacity: c
                ...
                if (i && !isNaN(x))
                    i.xy = s = this.getLabelPosition(x, s, i, g, k, t, a, u),
        ...
        Q.PlotLineOrBand.prototype = {
            render: function() {
                ...
                else if (o && o.length && (a.svgElem = n = u.path(o).attr(r).add(),
                    w))
        ...
        J.prototype = {
            ...
            init: function(a, b) {
                ...
                this.crosshair = q(d.crosshair, na(a.options.tooltip.crosshairs)[c ? 0 : 1], !1);
                var f, d = this.options.events;
                ya(this, a.axes) === -1 && (c && !this.isColorAxis ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this),
            ...
            setOptions: function(a) {
                this.options = x(this.defaultOptions, this.isXAxis ? {} : this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], x(F[this.coll], a))
            },
                ...
                p(a.series, function(c) {
                    if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                        ...
                        if (a.isXAxis) {
                            if (d = c.xData,
                                d.length)
                                a.dataMin = A(q(a.dataMin, d[0]), Ta(d)),
                                    a.dataMax = v(q(a.dataMax, d[0]), Da(d))
                        } else {
                            c.getExtremes();
                            e = c.dataMax;
                            c = c.dataMin;
            ...
            setTickPositions: function(a) {
                ...
                d.type !== b.linkedParent.options.type && oa(11, 1)) : (b.min = q(b.userMin, d.min, b.dataMin),
                    b.max = q(b.userMax, d.max, b.dataMax));
                if (g)
                    !a && A(b.min, q(b.dataMin, b.min)) <= 0 && oa(10, 1),
                        b.min = ia(Ia(b.min)),
                        b.max = ia(Ia(b.max));
                if (b.range && t(b.max))
                ...
                if (!qa && !b.axisPointRange && !b.usePercentage && !j && t(b.min) && t(b.max) && (c = b.max - b.min)) {
                    if (!t(d.min) && !t(b.userMin) && m && (b.dataMin < 0 || !b.ignoreMinPadding))
                        b.min -= c * m;
                    if (!t(d.max) && !t(b.userMax) && l && (b.dataMax > 0 || !b.ignoreMaxPadding))
                        b.max += c * l
                }
                if (ma(d.floor))
                ...
                b.min === b.max || b.min === void 0 || b.max === void 0 ? b.tickInterval = 1 : j && !n && y === b.linkedParent.options.tickPixelInterval ? b.tickInterval = b.linkedParent.tickInterval : (b.tickInterval = q(n, qa ? 1 : (b.max - b.min) * y / v(b.len, y)),
                !t(n) && b.len < y && !this.isRadial && !this.isLog && !qa && e && f && (I = !0,
                    b.tickInterval /= 4));
                ...
                if (!n && b.tickInterval < o)
                    b.tickInterval = o;
                if (!h && !g && !n)
                    b.tickInterval = vb(b.tickInterval, null, ub(b.tickInterval), d);
                ...
                if (!a)
                    !b.ordinalPositions && (b.max - b.min) / b.tickInterval > v(2 * b.len, 200) && oa(19, !0),
                ...
                if (!j)
                    ...
                    !e && !f && !qa && a.length === 2 && a.splice(1, 0, (g + d) / 2),
            ...
            zoom: function(a, b) {
                var c = this.dataMin
                    , d = this.dataMax
                    , e = this.options;
                this.allowZoomOutside || (t(c) && a <= A(c, q(e.min, c)) && (a = r),
                t(d) && b >= v(d, q(e.max, d)) && (b = r));
            ...
            getExtremes: function() {
                var a = this.isLog;
                return {
                    min: a ? ia(ra(this.min)) : this.min,
                    max: a ? ia(ra(this.max)) : this.max,
            ...
            getThreshold: function(a) {
                var b = this.isLog
                    , c = b ? ra(this.min) : this.min
                    , b = b ? ra(this.max) : this.max;
            ...
            getOffset: function() {
                var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, j, k, l = 0, m, n = 0, o = d.title, y = d.labels, I = 0, qa = b.axisOffset, b = b.clipOffset, w = [-1, 1, 1, -1][h], u, s = 1, x = q(y.maxStaggerLines, 5), O, A, z, C, R;
                ...
                if (j || a.isLinked) {
                    a.labelAlign = q(y.align || a.autoLabelAlign(y.rotation));
                    p(e, function(b) {
                ...
                if (o && o.text && o.enabled !== !1) {
                    ...
                    if (k)
                        l = a.axisTitle.getBBox()[g ? "height" : "width"],
                            m = o.offset,
                            n = t(m) ? 0 : q(o.margin, g ? 5 : 10);
                    a.axisTitle[k ? "show" : "hide"]()
                }
                a.offset = w * q(d.offset, qa[h]);
            ...
            render: function() {
                ...
                if (u || h)
                    ...
                    q && a.min === 0 && (l[-1] || (l[-1] = new ab(a,-1,null,!0)),
                        l[-1].render(-1))),
                    y && p(i, function(b, c) {
                        if (c % 2 === 0 && b < a.max)
                            n[b] || (n[b] = new Q.PlotLineOrBand(a)),
                                s = b + q,
            ...
            drawCrosshair: function(a, b) {
                if (this.crosshair)
                    if ((t(b) || !q(this.crosshair.snap, !0)) === !1)
                        this.hideCrosshair();
                    else {
        ...
        J.prototype.getTimeTicks = function(a, b, c, d) {
            ...
            if (t(b)) {
                j >= H.second && (i.setMilliseconds(0),
                    i.setSeconds(j >= H.minute ? 0 : k * V(i.getSeconds() / k)));
                if (j >= H.minute)
                    i[Mb](j >= H.hour ? 0 : k * V(i[xb]() / k));
                if (j >= H.hour)
                    i[Nb](j >= H.day ? 0 : k * V(i[yb]() / k));
                if (j >= H.day)
                    i[Ab](j >= H.month ? 1 : k * V(i[Wa]() / k));
                j >= H.month && (i[Ob](j >= H.year ? 0 : k * V(i[lb]() / k)),
                    h = i[mb]());
                j >= H.year && (h -= h % k,
                    i[Pb](h));
                if (j === H.week)
                    i[Ab](i[Wa]() - i[zb]() + q(d, 1));
                b = 1;
                Na && (i = new Date(i.getTime() + Na));
                h = i[mb]();
                for (var d = i.getTime(), l = i[lb](), m = i[Wa](), n = g ? Na : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c; )
                    e.push(d),
                        j === H.year ? d = kb(h + b * k, 0) : j === H.month ? d = kb(h, l + b * k) : !g && (j === H.day || j === H.week) ? d = kb(h, l, m + b * k * (j === H.day ? 1 : 7)) : d += j * k,
                        b++;
                e.push(d);
                p(pb(e, function(a) {
        ...
        J.prototype.normalizeTimeTickInterval = function(a, b) {
            ...
            for (g = 0; g < c.length; g++)
                if (d = c[g],
                    e = H[d[0]],
                    f = d[1],
                c[g + 1] && a <= (e * f[f.length - 1] + H[c[g + 1][0]]) / 2)
                    break;
        ...
        J.prototype.getLogTickPositions = function(a, b, c, d) {
            ...
            if (a >= 0.5)
                ...
                a = vb(a, null, ub(a)),
                g = za(this.getLinearTickPositions(a, b, c), Ia),
                !d)
        ...
        Ib.prototype = {
            ...
            refresh: function(a, b) {
                ...
                i === !1 ? this.hide() : (this.isHidden && (gb(d),
            ...
            tooltipHeaderFormatter: function(a) {
                var b = a.series, c = b.tooltipOptions, d = c.dateTimeLabelFormats, e = c.xDateFormat, f = b.xAxis, g = f && f.options.type === "datetime" && ma(a.key), c = c.headerFormat, f = f && f.closestPointRange, h;
                if (g && !e) {
                    if (f)
                        for (h in H) {
        ...
        Za.prototype = {
            ...
            runPointActions: function(a) {
                ...
                if (d && !this._onDocumentMouseMove)
                    this._onDocumentMouseMove = function(a) {
                        if (ba[ua])
                            ba[ua].pointer.onDocumentMouseMove(a)
                    }
                        ,
            ...
            onContainerClick: function(a) {
                var b = this.chart
                    ...
                    , a = this.normalize(a);
                a.cancelBubble = !0;
                b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (N(c.series, "click", s(a, {
                    point: c
                })),
                b.hoverPoint && c.firePointEvent("click", a)) : (s(a, this.getCoordinates(a)),
                b.isInsidePlot(a.chartX - d, a.chartY - e) && N(b, "click", a)))
            },
            ...
            destroy: function() {
                ...
                fb || (U(D, "mouseup", this.onDocumentMouseUp),
                    U(D, "touchend", this.onDocumentTouchEnd));
        ...
        if (S.PointerEvent || S.MSPointerEvent) {
            var Aa = {}
                ...
                , Kb = function(a, b, c, d) {
                a = a.originalEvent || a;
                if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && ba[ua])
                    d(a),
                        d = ba[ua].pointer,
                        d[b]({
                            type: c,
        ...
        rb.prototype = {
            ...
            renderItem: function(a) {
                ...
                if (!p) {
                    ...
                    a.legendItem = p = c.text(d.labelFormat ? La(d.labelFormat, a) : d.labelFormatter.call(a), l ? f + g : -g, this.baseline || 0, s).css(x(a.visible ? h : i)).attr({
                        align: l ? "left" : "right",
                        zIndex: 2
                    }).add(a.legendGroup);
                    if (!this.baseline)
                ...
                if (e && this.itemX - y + f > (m || b.chartWidth - 2 * j - y - d.x))
                    this.itemX = y,
            ...
            getAllItems: function() {
                ...
                p(this.chart.series, function(b) {
                    var c = b.options;
                    if (q(c.showInLegend, !t(c.linkedTo) ? r : !1, !0))
        ...
        xa.prototype = {
            ...
            layOutTitles: function(a) {
                ...
                !e.floating && !e.verticalAlign && (b = Xa(b + d.getBBox().height)));
            ...
            getChartSize: function() {
                ...
                if (!t(b))
                    this.containerWidth = ob(c, "width");
                if (!t(a))
                    this.containerHeight = ob(c, "height");
            ...
            getContainer: function() {
                ...
                e = "highcharts-" + Eb++;
                if (Qa(a))
                    this.renderTo = a = D.getElementById(a);
                a || oa(13, !0);
            ...
            drawChartBox: function() {
                ...
                if (k)
                    f ? f.animate(w) : this.plotBackground = b.rect(o, y, q, p, 0).attr({
                        fill: k
                    }).add().shadow(a.plotShadow);
                if (l)
                    h ? h.animate(w) : this.plotBGImage = b.image(l, o, y, q, p).add();
                r ? r.animate({
                    width: u.width,
                    height: u.height
                ...
                if (m)
                    g ? g.animate(g.crisp({
                        ...
                        width: q,
                        height: p
                    })) : this.plotBorder = b.rect(o, y, q, p, 0, -m).attr({
            ...
            linkSeries: function() {
                ...
                p(b, function(b) {
                    ...
                    if (Qa(d) && (d = d === ":previous" ? a.series[b.index - 1] : a.get(d)))
        ...
        L.prototype = {
            ...
            setOptions: function(a) {
                ...
                this.userOptions = a;
                c = x(e, c.series, a);
                this.tooltipOptions = x(F.tooltip, F.plotOptions[this.type].tooltip, b.tooltip, d.series && d.series.tooltip, d[this.type] && d[this.type].tooltip, a.tooltip);
            ...
            processData: function(a) {
                ...
                for (a = b.length - 1; a >= 0; a--)
                    d = b[a] - b[a - 1],
                    !f && b[a] > n && b[a] < m && k++,
                        d > 0 && (g === r || d < g) ? g = d : d < 0 && this.requireSorting && oa(15);
                this.cropped = f;
                this.cropStart = e;
            ...
            generatePoints: function() {
                ...
                for (m = 0; m < g; m++)
                    i = h + m,
                        j ? l[m] = (new f).init(this, [d[m]].concat(na(e[m]))) : (b[i] ? k = b[i] : a[i] !== r && (b[i] = k = (new f).init(this, a[i], d[m])),
                            l[m] = k);
                if (b && (g !== (c = b.length) || j))
                    for (m = 0; m < c; m++)
                        if (m === h && !j && (m += g),
            ...
            translate: function() {
                ...
                for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === "between" || ma(i), k = a.threshold, a = 0; a < g; a++) {
                    var l = f[a]
                        ...
                        , n = l.y
                        , o = l.low
                        , y = b && e.stacks[(this.negStacks && n < k ? "-" : "") + this.stackKey];
                    if (e.isLog && n <= 0)
                        l.y = n = null;
                    l.plotX = c.translate(m, 0, 0, 0, 1, i, this.type === "flags");
                    if (b && this.visible && y && y[m])
                        y = y[m],
                            n = y.points[this.index + "," + a],
                            o = n[0],
                            n = n[1],
                        o === 0 && (o = q(k, e.min)),
                        e.isLog && o <= 0 && (o = null),
                            l.total = l.stackTotal = y.total,
                            l.percentage = y.total && l.y / y.total * 100,
                            l.stackY = n,
            ...
            drawPoints: function() {
                ...
                var l = this.pointAttr[""], m, n = this.markerGroup, o = q(d.enabled, this.activePointCount < 0.5 * this.xAxis.len / d.radius);
                if (d.enabled !== !1 || this._hasPointMarkers)
                    for (f = b.length; f--; )
                        if (g = b[f],
                            ...
                            k = g.graphic,
                            i = g.marker || {},
                            a = o && i.enabled === r || i.enabled,
                            m = c.isInsidePlot(u(d), e, c.inverted),
                        a && e !== r && !isNaN(e) && g.y !== null)
                            if (a = g.pointAttr[g.selected ? "select" : ""] || l,
                                h = a.r,
                                i = q(i.symbol, this.symbol),
                                j = i.indexOf("url") === 0,
                                k)
                                k[m ? "show" : "hide"](!0).animate(s({
                                    x: d - h,
                                    y: e - h
                                }, k.symbolName ? {
                                    width: 2 * h,
            ...
            getAttribs: function() {
                ...
                b.marker ? (e.radius = e.radius || c.radius + e.radiusPlus,
                    e.lineWidth = e.lineWidth || c.lineWidth + e.lineWidthPlus) : e.color = e.color || Ha(e.color || g).brighten(e.brightness).get();
                ...
                if (!i || g < i || k)
                    for (; g--; ) {
                        ...
                        if (k) {
                            ...
                            f = d.hover = d.hover || {};
                            if (!b.marker)
                                f.color = f.color || !i.options.color && e.color || Ha(i.color).brighten(f.brightness || e.brightness).get();
                            f = {
                                color: i.color
                            };
                            if (!o)
                ...
                for (p = 0; p < d; p++) {
                    ...
                    if (!l[o][r])
                        m[o] && m[o][r] ? (l[o][r] = m[o][r],
                            l[o][r].total = null) : l[o][r] = new Qb(k,k.options.stackLabels,n,r,g);
                    o = l[o][r];
                    o.points[q] = [o.cum || 0];
                    e === "percent" ? (n = n ? h : i,
                        j && l[n] && l[n][r] ? (n = l[n][r],
                            o.total = n.total = v(n.total, o.total) + P(w) || 0) : o.total = ia(o.total + (P(w) || 0))) : o.total = ia(o.total + (w || 0));
                    o.cum = (o.cum || 0) + (w || 0);
        ...
        var va = ha(L, {
            ...
            getSegments: function() {
                ...
                if (this.options.stacking && !this.cropped) {
                    ...
                    L.prototype.getSegments.call(this),
                        b = this.segments;
                this.segments = b
            },
            getSegmentPath: function(a) {
                var b = L.prototype.getSegmentPath.call(this, a), c = [].concat(b), d, e = this.options;
                d = b.length;
            ...
            drawGraph: function() {
                ...
                p(f, function(d) {
                    ...
                    f ? f.animate({
                        ...
                        fill: q(d[2], Ha(d[1]).setOpacity(q(c.fillOpacity, 0.75)).get()),
                        zIndex: 0
                    }).add(a.group)
                })
            },
        ...
        Ca = ha(Ca, {
            type: "areaspline",
            closedStacks: !0,
            getSegmentPath: va.getSegmentPath,
            closeSegment: va.closeSegment,
            drawGraph: va.drawGraph,
            drawLegendSymbol: T.drawRectangle
        });
        B.areaspline = Ca;
        W.column = x(E, {
        ...
        Ca = ha(L, {
            ...
            translate: function() {
                ...
                p(a.points, function(c) {
                    ...
                    s = v(h, d) - w;
                    P(s) < g && g && (s = g,
                        w = u(P(w - f) > g ? d - g : f - (e.translate(c.y, 0, 1, 0, 1) <= f ? g : 0)));
                    c.barX = p;
                    c.pointWidth = i;
                    c.tooltipPos = b.inverted ? [e.len - h, a.xAxis.len - p - r / 2] : [p + r / 2, h];
                    r = u(p + r) + l;
                    p = u(p) + l;
                    r -= p;
                    d = P(w) < 0.5;
                ...
                p(a.points, function(h) {
                    ...
                    if (i !== r && !isNaN(i) && h.y !== null)
                        f = h.shapeArgs,
                            ...
                            j ? (gb(j),
                                j.attr(i)[b.pointCount < e ? "animate" : "attr"](x(f))) : h.graphic = d[h.shapeType](f).attr(g).attr(i).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
                    else if (j)
                        h.graphic = j.destroy()
                })
            },
        ...
        E = {
            ...
            pointClass: ha(Ba, {
                ...
                setVisible: function(a) {
                    ...
                    c.options.data[ya(b, c.data)] = b.options;
            ...
            translate: function(a) {
                ...
                for (m = 0; m < n; m++) {
                    ...
                    o.angle = h;
                    e = A(e, l / 2);
                    o.labelPos = [a[0] + f + ea(h) * l, a[1] + g + ja(h) * l, a[0] + f + ea(h) * e, a[1] + g + ja(h) * e, a[0] + f, a[1] + g, l < 0 ? "center" : o.half ? "right" : "left", h]
                }
            },
            drawGraph: null,
            drawPoints: function() {
        ...
        L.prototype.drawDataLabels = function() {
            ...
            if (d.enabled || a._hasPointLabels)
                ...
                !a.hasRendered && q(d.defer, !0) && (i.attr({
                    opacity: 0
                }),
                    z(a, "afterAnimate", function() {
                        a.visible && i.show();
                    ...
                    p(e, function(b) {
                        ...
                        if (l && !e)
                            ...
                            if (l)
                                ...
                                for (n in l)
                                    l[n] === r && delete l[n];
                                l = b.dataLabel = a.chart.renderer[e ? "text" : "label"](h, 0, -999, null, null, null, d.useHTML).attr(l).css(s(d.style, c && {
                                    cursor: c
        ...
        if (B.pie)
            B.pie.prototype.drawDataLabels = function() {
                var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = q(e.connectorPadding, 10), g = q(e.connectorWidth, 1), h = d.plotWidth, i = d.plotHeight, j, k, l = q(e.softConnector, !0), m = e.distance, n = a.center, o = n[2] / 2, y = n[1], r = m > 0, s, w, t, x = [[], []], z, O, D, G, C, R = [0, 0, 0, 0], H = function(a, b) {
                    return b.y - a.y
                };
                        ...
                        if (J) {
                            ...
                            if (m > 0) {
                                ...
                                for (C = 0; C < J; C++) {
                                    ...
                                    if (E < C && B[C] !== null)
                                        ...
                                        for (w < J - C + E && B[C] !== null && (E = w - J + C); B[E] === null; )
                                            E++;
                                    K.push({
                                        i: E,
                                        y: B[E]
                            ...
                            for (C = 0; C < J; C++) {
                                ...
                                if (this.options.size === null)
                                    w = s.width,
                                        z - w < f ? R[3] = v(u(w - z + f), R[3]) : z + w > h - f && (R[1] = v(u(z + w - h + f), R[1])),
                                        O - b / 2 < 0 ? R[0] = v(u(-O + b / 2), R[0]) : O + b / 2 > i && (R[2] = v(u(O + b / 2 - i), R[2]))
                            }
                        }
                    }
                    if (Da(R) === 0 || this.verifyDataLabelOverflow(R))
                        this.placeDataLabels(),
                        r && g && p(this.points, function(b) {
                            j = b.connector;
                            t = b.labelPos;
                            if ((s = b.dataLabel) && s._pos)
                                D = s._attr.visibility,
                                    z = s.connX,
                                    O = s.connY,
                                    k = l ? ["M", z + (t[6] === "left" ? 5 : -5), O, "C", z, O, 2 * t[2] - t[4], 2 * t[3] - t[5], t[2], t[3], "L", t[4], t[5]] : ["M", z + (t[6] === "left" ? 5 : -5), O, "L", t[2], t[3], "L", t[4], t[5]],
                                    j ? (j.animate({
                                        d: k
                                    }),
                ...
                ,
                B.pie.prototype.alignDataLabel = pa,
        ...
        if (B.pie)
            B.pie.prototype.drawTracker = ib.drawTrackerPoint;
        if (B.scatter)
            va.prototype.drawTracker = ib.drawTrackerPoint;
        s(rb.prototype, {
                    ...
                    b || p(e.getSelectedPoints(), function(a) {
                        if (a.selected && a !== c)
                            a.selected = a.options.selected = !1,
                                d.options.data[ya(a, d.data)] = a.options,
                                a.setState(""),
            ...
            setState: function(a, b) {
                ...
                if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (j || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
                    ...
                    if ((c = f[a] && f[a].halo) && c.size) {
                        ...
                        n.attr(s({
                            fill: Ha(this.color || e.color).setOpacity(c.opacity).get()
        ...
        M(J.prototype, "getTimeTicks", function(a, b, c, d, e, f, g, h) {
            ...
            if (h && a.unitRange <= H.hour) {
                j = p.length - 1;
                for (i = 1; i < j; i++)
                    (new Date(p[i] - Na))[Wa]() !== (new Date(p[i - 1] - Na))[Wa]() && (l[p[i]] = "day",
                        m = !0);
                m && (l[p[0]] = "day");
                a.higherRanks = l
            }
            ...
            if (h && t(s)) {
                ...
                for (w = void 0; h--; )
                    i = j[h],
                        d = w - i,
                        w && d < s * 0.8 && (m === null || d < m * 0.8) ? (l[p[h]] && !l[p[h + 1]] ? (d = h + 1,
                            w = i) : d = h,
                            p.splice(d, 1)) : w = i
            }
            return p
            ...
            beforeSetTickPositions: function() {
                ...
                if (this.options.ordinal) {
                    ...
                    c ? (this.ordinalPositions = b,
                        ...
                        d = this.val2lin(A(e, b[b.length - 1]), !0),
        ...
        M(L.prototype, "getSegments", function(a) {
        ...
        var ca = L.prototype
            ...
            , Wb = [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1]], ["week", [1]], ["month", [1, 3, 6]], ["year", null]]
            , Pa = {
            sum: function(a) {
                var b = a.length, c;
                if (!b && a.hasNulls)
        ...
        ca.groupData = function(a, b, c, d) {
            var e = this.data, f = this.options.data, g = [], h = [], i = a.length, j, k, l = !!b, m = [[], [], [], []], d = typeof d === "function" ? d : Pa[d], n = this.pointArrayMap, o = n && n.length, p;
            for (p = 0; p <= i; p++)
                if (a[p] >= c[0])
                    break;
            for (; p <= i; p++) {
            ...
            if (gc.apply(this, arguments) !== !1 && d) {
                ...
                if (j) {
                    ...
                    var k = a.getExtremes()
                        ...
                        , h = j * (k - d) / h * i
                        , j = a.getTimeTicks(a.normalizeTimeTickInterval(h, c.units || Wb), d, k, null, f, this.closestPointRange)
        ...
        M(ca, "setOptions", function(a, b) {
            ...
            if (Vb[d])
                f || (f = x(kc, Vb[d])),
                    c.dataGrouping = x(f, e.series && e.series.dataGrouping, e[d].dataGrouping, b.dataGrouping);
                ...
                p(a.points, function(k) {
                    if (k.plotY !== r)
                        i = k.graphic,
                            ...
                            j = u(k.plotX) - f,
                            g = u(k.shapeArgs.width / 2),
                            h = ["M", j, u(k.yBottom), "L", j, u(k.plotY)],
                        k.open !== null && (d = u(k.plotOpen) + f,
                            h.push("M", j, d, "L", j - g, d)),
                        k.close !== null && (e = u(k.plotClose) + f,
                ...
                p(a.points, function(p) {
                    ...
                    if (p.plotY !== r)
                        c = p.pointAttr[p.selected ? "selected" : ""] || d,
                            ...
                            g = X.min(e, f),
                            h = X.max(e, f),
                            o = u(p.shapeArgs.width / 2),
                            i = u(g) !== u(p.plotY),
                            j = h !== p.yBottom,
                            g = u(g) + k,
                            h = u(h) + k,
                            n = ["M", l - o, h, "L", l - o, g, "L", l + o, g, "L", l + o, h, "Z", "M", l, g, "L", l, i ? u(p.plotY) : g, "M", l, h, "L", l, j ? u(p.yBottom) : h],
                            m ? m.animate({
                                d: n
                    ...
                    f !== r && e >= 0 && !a)
                        a = k.pointAttr[k.selected ? "select" : ""] || b,
                            l ? l.attr({
                                ...
                                anchorX: n,
                                anchorY: o
                            }) : k.graphic = d.label(k.options.title || g.title || "A", e, f, i, n, o, g.useHTML).css(x(g.style, k.style)).attr(a).attr({
        ...
        Bb.prototype = {
                ...
                if (!isNaN(a)) {
                    ...
                    if (!(l.translate(d, !0) - l.translate(c, !0) < e.xAxis[0].minRange)) {
                        ...
                        if (z) {
                            ...
                            this.outline[e]({
                                d: ["M", i, E, "L", g + b + B, E, g + b + B, E + C, "L", g + c - B, E + C, "L", g + c - B, E, i + j, E].concat(r.maskInside ? ["M", g + b + B, E, "L", g + c - B, E] : [])
                            });
            ...
            init: function() {
                ...
                a.mouseDownHandler = function(d) {
                    var d = b.pointer.normalize(d), e = a.zoomedMin, f = a.zoomedMax, h = a.top, j = a.scrollbarHeight, m = a.scrollerLeft, n = a.scrollerWidth, o = a.navigatorLeft, p = a.navigatorWidth, q = a.scrollbarPad, r = a.range, s = d.chartX, t = d.chartY, d = b.xAxis[0], u, v = eb ? 10 : 7;
                    if (t > h && t < h + g + j)
                ...
                a.navigatorEnabled ? (a.xAxis = c = new J(b,x({
                    ...
                    m || f.series.data ? a.addBaseSeries() : b.series.length === 0 && M(b, "redraw", function(c, d) {
        ...
        Cb.prototype = {
            ...
            updateButtonStates: function(a) {
                var b = this
                    ...
                    , j = b.buttons;
                a && c.fixedRange !== u(d.max - d.min) && (j[h] && j[h].setState(0),
                    b.setSelected(null));
                p(b.buttonOptions, function(a, c) {
                    var e = a._range
                        ...
                        , q = a.type === "ytd" && wa("%Y", f) === wa("%Y", g);
                    e === u(d.max - d.min) && c !== h ? (b.setSelected(c),
            ...
            setInputValue: function(a, b) {
                ...
                this[a + "DateBox"].attr({
                    text: wa(c.inputDateFormat || "%b %e, %Y", this[a + "Input"].HCTime)
                })
            },
            drawInput: function(a) {
                ...
                i.onchange = function() {
                    var a = i.value
                        ...
                        , j = e.dataMax;
                    isNaN(d) && (d = a.split("-"),
                        d = Date.UTC(G(d[0]), G(d[1]) - 1, G(d[2])));
                    isNaN(d) || (F.global.useUTC || (d += (new Date).getTimezoneOffset() * 6E4),
            ...
            destroy: function() {
                ...
                for (e in this)
                    this[e] && e !== "chart" && (this[e].destroy ? this[e].destroy() : this[e].nodeType && Ua(this[e])),
                        this[e] = null
            }
        };
        ...
        M(xa.prototype, "init", function(a, b, c) {
            z(this, "init", function() {
                if (this.options.rangeSelector.enabled)
                    this.rangeSelector = new Cb(this)
            });
            a.call(this, b, c)
        });
        Q.RangeSelector = Cb;
        ...
        M(J.prototype, "autoLabelAlign", function(a) {
        ...
        J.prototype.getPlotLinePath = function(a, b, c, d, e) {
            ...
            s = f.isXAxis ? t(f.options.yAxis) ? [h.yAxis[f.options.yAxis]] : za(g, function(a) {
                return a.yAxis
            }) : t(f.options.xAxis) ? [h.xAxis[f.options.xAxis]] : za(g, function(a) {
                return a.xAxis
            });
        ...
        la.prototype.crispPolyLine = function(a, b) {
            ...
            for (c = 0; c < a.length; c += 6)
                a[c + 1] === a[c + 4] && (a[c + 1] = a[c + 4] = u(a[c + 1]) - b % 2 / 2),
                a[c + 2] === a[c + 5] && (a[c + 2] = a[c + 5] = u(a[c + 2]) + b % 2 / 2);
            return a
        }
        ;
        if (Ya === Q.VMLRenderer)
            hb.prototype.crispPolyLine = la.prototype.crispPolyLine;
        ...
        M(L.prototype, "render", function(a) {
            if (this.chart.options._stock)
                !this.clipBox && this.animate && this.animate.toString().indexOf("sharedClip") !== -1 ? (this.clipBox = x(this.chart.clipBox),
